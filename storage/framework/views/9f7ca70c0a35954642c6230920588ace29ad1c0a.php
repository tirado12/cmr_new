...
<div class="mt-10 sm:mt-0 shadow-2xl bg-white rounded-lg">
      ...
      <div class="mt-5 md:mt-0 md:col-span-2">
        <form action="<?php echo e(route('proveedor.update', $proveedor)); ?>" method="POST">
          <?php echo csrf_field(); ?>
            ...
            <div class="px-4 py-5 bg-white sm:p-6">
              <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-3">
                  ...
                  <input type="text" name="rfc" id="rfc" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($proveedor->rfc); ?>" required>
                </div>
  
                <div class="col-span-6 sm:col-span-3">
                  <label for="razon_social" class="block text-sm font-medium text-gray-700">Razón social *</label>
                  <input type="text" name="razon_social" id="razon_social" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($proveedor->razon_social); ?>" required>
                </div>
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Nueva carpeta (2)\CMR\Sistema\cmr_app\resources\views/proveedores/edit.blade.php ENDPATH**/ ?>