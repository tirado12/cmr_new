...
<?php $__env->startSection('title','Editar Contratista'); ?>
...
<div class="mt-10 sm:mt-0 shadow-2xl bg-white rounded-lg">
      ...
      <div class="mt-5 md:mt-0 md:col-span-2">
        <form action="<?php echo e(route('contratistas.update', $contratista)); ?>" method="POST" id="formulario" name="formulario">
          <?php echo csrf_field(); ?>
          ...
          <div class="shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 bg-white sm:p-6">
              <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-3">
                  ...
                  <input type="text" name="rfc" id="rfc" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($contratista->rfc); ?>">
                ...
                <div class="col-span-6 sm:col-span-3">
                  ...
                  <input type="text" name="razon_social" id="razon_social" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($contratista->razon_social); ?>">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="representante_legal" id="representante_legal" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($contratista->representante_legal); ?>">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="domicilio" id="domicilio" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($contratista->domicilio); ?>">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="tel" name="telefono" id="telefono" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($contratista->telefono); ?>">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="correo" id="correo" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($contratista->correo); ?>">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="numero_padron_contratista" id="numero_padron_contratista" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($contratista->numero_padron_contratista); ?>">
            ...
            <div class="px-4 py-3 bg-gray-100 sm:px-6">
              ...
              <div class="text-right">
                <a type="button" href="<?php echo e(route('contratistas.index')); ?>" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-gray-500 hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                  Regresar
                </a>
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Nueva carpeta (2)\CMR\Sistema\cmr_app\resources\views/contratistas/edit.blade.php ENDPATH**/ ?>