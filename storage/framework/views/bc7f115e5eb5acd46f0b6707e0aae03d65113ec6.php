    ...
    <td>
        <div class="text-sm leading-5 font-medium text-gray-900">
            <button
                ...
                type="button"
                onclick="toggleModal_municipio('modal-id', <?php echo e($cliente->municipio); ?>)">
                <?php echo e($cliente->municipio->nombre); ?>
    ...
    <td>
        <div class="flex justify-center">
            <form action="<?php echo e(route('clientes.destroy', $cliente->id_cliente)); ?>"
                ...
                <div>
                    <a type="button"
                        href="<?php echo e(route('clientes.edit', $cliente->id_cliente)); ?>"
                        class="bg-white text-sm text-blue-500 font-normal text-ms p-2 rounded rounded-lg">Editar</a>
                    <button
                        class="bg-transparent text-blue-500 active:bg-transparent font-normal  text-sm p-2  rounded outline-none focus:outline-none  ease-linear transition-all duration-150"
                        type="button"
                        onclick="toggleModal('modal-cliente', <?php echo e($cliente); ?>)">
                        Detalles
                    </button>
                    <!--<?php echo csrf_field(); ?>
    ...
    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center"
        ...
        <div class="relative w-auto my-6 mx-auto max-w-3xl">
            ...
            <div
                ...
                <!--body-->
                <form action="<?php echo e(route('clientes.store', $cliente->id)); ?>"
                    method="POST"
                            ...
                            <div class="col-span-8">
                                ...
                                <select id="municipio_id"
                                    ...
                                    <?php $__currentLoopData = $municipios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $municipio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($municipio->id_municipio); ?>"
                                            <?php echo e($municipio->id_municipio == old('municipio_id') ? 'selected' : ''); ?>>
                                            <?php echo e($municipio->nombre); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-span-8">
                                ...
                                <div class="grid grid-cols-8">
                                    <div class="col-span-4 mr-3">
                                        ...
                                        <input type="number"
                                            ...
                                            value="<?php echo e(old('anio_inicio')); ?>">
                                    </div>
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Documentos\CMR\Creatividad\Sistema\cmr_app\resources\views/cliente/index.blade.php ENDPATH**/ ?>