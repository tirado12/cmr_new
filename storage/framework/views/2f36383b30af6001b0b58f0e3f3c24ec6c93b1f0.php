...
<?php $__env->startSection('contenido'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/styles_personalizados.css')); ?>">
    <style>
    ...
    <div class="mt-6 contenedor p-8 shadow-2xl bg-white rounded-lg">
        ...
        <div class="mt-5 grid grid-cols-9 gap-4">
            ...
            <div class="col-span-2">
                ...
                <label id="numero_obra" name="numero_obra" class="block text-base font-bold text-gray-700 py-3 px-5 "><?php echo e(str_pad($obj_obra->get('obra')->numero_obra,3,"0",STR_PAD_LEFT)); ?></label>
            </div>
            <div class="col-span-7">
                ...
                <form action="<?php echo e(route('update_obra')); ?>" method="POST" accept-charset="UTF-8" enctype="multipart/form-data" id="formulario_nc" class="hidden ml-5">
                    <?php echo csrf_field(); ?>
                        ...
                        <div id="datos_generales">
                            <div class="grid grid-cols-8">
                                <div class="col-span-8">
                                    <input type="text" maxlength="100" name="nombre_corto" id="nombre_corto" autocomplete="nombre_corto" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obj_obra->get('obra')->nombre_corto_obra); ?>">
                                    ...
                                    <input type="number" name="obra_id" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obj_obra->get('obra')->id_obra); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!--<div class="sm:col-span-3">
                <p class="text-sm font-semibold">Región <br><span class="ml-5 text-base font-bold"><?php echo e($obj_obra->get('obra')->nombre_region); ?></span></p>
            </div>
            -->
            <div class="col-span-9 sm:col-span-3">
                <p class="text-sm"> <span class="font-semibold">Oficio de notificación</span><br>
                    <span class="ml-5">Número: <span class="text-base font-bold"><?php echo e($obj_obra->get('obra')->oficio_notificacion); ?></span></span><br>
                    <span class="ml-5">Fecha: <span class="text-base font-bold"><?php echo e(date('d-m-Y', strtotime($obj_obra->get('obra')->fecha_oficio_notificacion))); ?></span></span>
                </p>
            </div>

            <div class="col-span-9 sm:col-span-3">
                <p class="text-sm font-semibold">Monto de la obra<br><span class="ml-5 text-base font-bold"><?php echo e($service->formatNumber($obj_obra->get('obra')->monto_contratado)); ?></span></p>
                <?php if($obj_obra->get('obra')->modalidad_ejecucion == 1): ?>
                    <p class="text-sm font-semibold">Monto ejercicido<br><span class="ml-5 text-base font-bold"><?php echo e($service->formatNumber($total_admin)); ?></span></p>
                <?php endif; ?>
                <?php if($obj_obra->get('obra')->monto_modificado != null): ?>
                    <p class="text-sm font-semibold">Monto modificado: <br><span class="ml-5 text-base font-bold"><?php echo e($service->formatNumber($obj_obra->get('obra')->monto_modificado)); ?></span></p>
                <?php endif; ?>
            </div>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $fuentes_financiamiento; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fuente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <div class="">
                                        <span class="font-semibold"><?php echo e($fuente->nombre_corto); ?> &nbsp;&nbsp;&nbsp;</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="">
                                        <span class="font-bold"><?php echo e($service->formatNumber($fuente->monto)); ?></span><br>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="col-span-9 sm:col-span-3">
                <p class="text-sm font-semibold">Periodo de ejecución<br class="ocultar_periodo">
                    <span class="ml-5 text-sm font-normal ocultar_periodo">Fecha de inicio: <br><span class="ml-5 text-base font-bold ocultar_periodo"><?php echo e(date('d-m-Y', strtotime($obj_obra->get('obra')->fecha_inicio_programada))); ?></span></span>  <br>
                    <span class="ml-5 text-sm font-normal ocultar_periodo">Fecha de termino: <br><span class="ml-5 text-base font-bold ocultar_periodo"><?php echo e(date('d-m-Y', strtotime($obj_obra->get('obra')->fecha_final_programada))); ?></span></span> <br>

                    <?php if($obj_obra->get('obra')->modalidad_ejecucion == 2 && $obj_obra->get('obra')->fecha_final_programada != $obj_obra->get('obra')->fecha_final_real): ?>
                        <span class="ml-5 text-sm font-normal ocultar_periodo">Fecha de termino modificada: <br><span class="ml-5 text-base font-bold ocultar_periodo"><?php echo e(date('d-m-Y', strtotime($obj_obra->get('obra')->fecha_final_real))); ?></span></span> 
                    <?php endif; ?>
                </p>
                
                
                <?php if($obj_obra->get('obra')->modalidad_ejecucion == 1): ?>
                    <form action="<?php echo e(route('update_obra')); ?>" method="POST" accept-charset="UTF-8" enctype="multipart/form-data" id="formulario_periodo" class="hidden ml-5">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('POST'); ?>
                        <div class="relative flex-auto">
                            <div id="datos_generales">
                                <div class="grid grid-cols-8">
                                    <div class="col-span-8">
                                        <div class="col-span-8">
                                            ...
                                            <?php if($acta_priorizacion == null): ?>
                                                <input type="date" name="fecha_inicio" id="fecha_inicio" min="<?php echo e($obj_obra->get('obra')->ejercicio); ?>-01-01" max="<?php echo e($obj_obra->get('obra')->ejercicio); ?>-12-31" class="focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>">
                                            <?php else: ?>
                                                <input type="date" name="fecha_inicio" id="fecha_inicio" min="<?php echo e($acta_priorizacion->acta_priorizacion); ?>" max="<?php echo e($obj_obra->get('obra')->ejercicio); ?>-12-31" class="focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>">
                                            <?php endif; ?>
                                        ...
                                        <div class="col-span-8">
                                            ...
                                            <?php if($acta_priorizacion == null): ?>
                                                <input type="date" name="fecha_fin" id="fecha_fin" min="<?php echo e($obj_obra->get('obra')->ejercicio); ?>-01-01" max="<?php echo e($obj_obra->get('obra')->ejercicio); ?>-12-31" class="focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obj_obra->get('obra')->fecha_final_programada); ?>">
                                            <?php else: ?>
                                                <input type="date" name="fecha_fin" id="fecha_fin" min="<?php echo e($acta_priorizacion->acta_priorizacion); ?>" max="<?php echo e($obj_obra->get('obra')->ejercicio); ?>-12-31" class="focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obj_obra->get('obra')->fecha_final_programada); ?>">
                                            <?php endif; ?>
            ...
            <?php if($obj_obra->get('obra')->modalidad_ejecucion == 2): ?>
                <div class="col-span-9 sm:col-span-3">
                    <p class="text-sm font-semibold"> Contrato<br>
                        <span class="ml-5">Número: <span class="text-base font-bold"><?php echo e($obj_obra->get('contrato')->numero_contrato); ?></span></span><br>
                        <span class="ml-5">Fecha: <span class="text-base font-bold"><?php echo e(date('d-m-Y', strtotime($obj_obra->get('contrato')->fecha_contrato))); ?></span></span>
                    </p>
                </div>
            <?php endif; ?>
            ...
            <?php if($obj_obra->get('obra')->modalidad_ejecucion == 2): ?>
                <div class="col-span-9 sm:col-span-3">        
                    <p class="text-sm font-semibold">Contratista<br><span class="ml-5 text-base font-bold"><?php echo e($obj_obra->get('contrato')->razon_social); ?></span></p>
                </div>
            <?php endif; ?>
            <div class="col-span-9 sm:col-span-3">
            ...
            <?php endif; ?>
            <?php if($obj_obra->get('obra')->anticipo_monto > 0): ?>
                <div class="col-span-9 sm:col-span-3 flex items-center">
                    <div>
                        <p class="text-sm font-semibold">Monto de anticipo:<br>
                            <span class="ml-5 text-base font-bold">
                                <?php echo e($service->formatNumber($obj_obra->get('obra')->anticipo_monto)); ?>
                        ...
                        <p class="text-sm font-semibold">Total amortizado:<br>
                            <span class="ml-5 text-base font-bold">
                                <?php echo e($service->formatNumber($total_pagado->total_anticipo)); ?>
            ...
            <div class="col-span-9">
                <div class="grid grid-cols-9 gap-4">
                    <div class="col-span-9 sm:col-span-3">
                        ...
                        <p class="text-base font-bold modificar_af text-center"><?php echo e($obj_obra->get('obra')->avance_fisico); ?></p>
                        <form action="<?php echo e(route('update_obra')); ?>" method="POST" accept-charset="UTF-8" enctype="multipart/form-data" id="formulario_af" class="hidden ml-5">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('POST'); ?>
                            <div class="relative flex-auto">
                                <div>
                                    <div class="grid grid-cols-8">
                                        <div class="col-span-8">
                                            <input type="number" min="0" max="100" name="avance_fisico" id="avance_fisico" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obj_obra->get('obra')->avance_fisico); ?>">
                    ...
                    <div class="col-span-9 sm:col-span-3">
                        ...
                        <p class="text-base font-bold text-center"><?php echo e(number_format($obj_obra->get('obra')->avance_tecnico,0,'.','')); ?></p>
                    </div>
                    <div class="col-span-9 sm:col-span-3">
                        <p class="text-sm font-semibold text-center sm:text-left">Avance economico:</p>
                        <p class="text-base font-bold text-center"><?php echo e(number_format($obj_obra->get('obra')->avance_economico,0,'.','')); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="tab_container">
                <div class="tab_content" id="tab1">
                    ...
                    <div class="flex justify-center">
                        <a type="button" href="<?php echo e(route('edit_expediente', [$obj_obra->get('obra')->id_obra])); ?>" class="text-sm text-blue-500 underline background-transparent font-semibold outline-none focus:outline-none ease-linear transition-all duration-150 text-center">Modificar expediente técnico</a>
                    </div>
                    <div>
                                                ...
                                                <div class="flex items-center h-full">
                                                    ...
                                                    <div class="col-estado ml-2">
                                                        <div class="flex justify-center my-2">
                                                            ...
                                                            <?php break; ?>
                                                            <?php case (3): ?>
                                                            <img src="<?php echo e(asset('image/NA.svg')); ?>" alt="Workflow">
                                                            <?php break; ?>
                                                            <?php default: ?>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <div class="border sm:col-span-4 p-2">
                                                    <div class="flex items-center h-full">
                                                        <div class="col-nombre">
                                                            <p  class="dos-lineas">
                                                                Notas de bitácora.
                                                                Contrato de arrendamiento de maquinaria complementaria
                                                            </p>
                                                        </div>
                                                        <div class="col-estado ml-2">
                                                            <div class="flex justify-center my-2">
                                                ...
                                                <?php if($contratos_arrendamiento->first() != null): ?>
                                                    ...
                                                    <div class="border sm:col-span-8  p-2 mt-4">
                                                        ...
                                                        <div class="grid sm:grid-cols-8 gap-x-4 gap-y-1">
                                                            <?php $__currentLoopData = $contratos_arrendamiento; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contrato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="border sm:col-span-4 p-2 mt-1">
                                                                    <div class="flex items-center  h-full">
                                                                        <div class="col-nombre">
                                                                            <p>
                ...
                <?php if($obj_obra->get('obra')->modalidad_ejecucion == 1): ?>
                    <div class="tab_content" id="tab2">
                        <div class="">
                            ...
                            <?php if($total_admin<$obj_obra->get('obra')->monto_contratado): ?>
                                <div class="flex justify-center">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-center">
                                                            <?php echo e($lista->numero_lista_raya); ?>

                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-right">
                                                            <?php echo e($service->formatNumber($lista->total)); ?>

                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-right">
                                                        Del <b><?php echo e($service->formatDate($lista->fecha_inicio)); ?></b><br>
                                                        Al <b><?php echo e($service->formatDate($lista->fecha_fin)); ?></b>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-right">
                                                            <?php echo e($service->formatNumber($lista->isr)); ?>

                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-right">
                                                            <?php echo e($service->formatNumber($lista->mano_obra)); ?>

                                                        </div>
                                                    </td>
                                                    
                                                    <td>
                                                        <?php if($key == count($listas_raya) - 1): ?>
                                                            <div class="text-sm leading-5 font-medium text-gray-900 flex justify-center">
                                                                <button type="button" href="" class="bg-white text-sm text-blue-500 font-normal text-ms p-2 rounded rounded-lg" onclick="toggleModal_EditLista('modal-lista-raya-edit', <?php echo e($lista); ?>, '<?php echo e(str_pad($lista->numero_lista_raya,3,'0',STR_PAD_LEFT)); ?>')">Editar</button>
                                                            </div>
                                                        <?php endif; ?>
                                                    </td>
                    ...
                    <div class="tab_content" id="tab3">
                        <div class="">
                            ...
                            <?php endif; ?>
                            <?php if($contratos_arrendamiento != null): ?>
                                <div class="mt-5">
                                    <table id="example" class="table table_estimacion table-striped bg-white" style="width:100%;">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $contratos_arrendamiento; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $contrato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-center">
                                                            <?php echo e($contrato->numero_contrato); ?>

                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-right">
                                                            <?php echo e($service->formatDate($contrato->fecha_contrato)); ?>

                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-right">
                                                            <?php echo e($service->formatNumber($contrato->monto_contratado)); ?>

                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-right">
                                                        Del <b><?php echo e($service->formatDate($contrato->fecha_inicio)); ?></b><br>
                                                        Al <b><?php echo e($service->formatDate($contrato->fecha_fin)); ?></b>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-center">
                                                            <?php echo e($contrato->razon_social); ?>
                                                    ...
                                                    <td>
                                                            ...
                                                            <div class="text-sm leading-5 font-medium text-gray-900 flex justify-center">
                                                                <a type="button" href="<?php echo e(route('show_contrato', ['id' => $contrato->id_contrato_arrendamiento, 'id_obra' => $obj_obra->get('obra')->id_obra])); ?>" class="bg-white text-sm text-blue-500 font-normal text-ms p-2 rounded rounded-lg">Detalles</a>
                                                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $facturas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $factura): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-center">
                                                            <?php echo e($factura->folio_fiscal); ?>

                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-right">
                                                            <?php echo e($service->formatDate($factura->fecha)); ?>

                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-right">
                                                            <?php echo e($service->formatNumber($factura->total)); ?>

                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-center">
                                                            <?php echo e($factura->razon_social); ?>

                                                        </div>
                                                    </td>
                                                    
                                                    <td>
                                                        <?php if($key == count($facturas) - 1): ?>
                                                            <div class="text-sm leading-5 font-medium text-gray-900 flex justify-center">
                                                                <button type="button" href="" class="bg-white text-sm text-blue-500 font-normal text-ms p-2 rounded rounded-lg" onclick="toggleModal_EditFactura('modal-edit-factura', <?php echo e($factura); ?>)">Editar</button>
                                                            </div>
                                                        <?php endif; ?>
                                                    </td>
                ...
                <?php if($obj_obra->get('obra')->modalidad_ejecucion == 2): ?>
                                ...
                                <div class="mt-5">
                                    <table id="example" class="table table_estimacion table-striped bg-white" style="width:100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $pagos_obra; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pago): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-center">
                                                            <?php echo e($key + 1); ?>
                                                    ...
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-center">
                                                            <div class="div-estado-proceso">
                                                                <?php if($pago->fecha_recepcion != null): ?>
                                                                    <div class="flex justify-center">
                                                                        <img src="<?php echo e(asset('image/Bien.svg')); ?>" alt="Workflow">
                                                                    </div>
                                                                    <p class="font-bold"><?php echo e($service->formatDate($pago->fecha_recepcion)); ?></p>
                                                                <?php else: ?>
                                                                    <div class="flex justify-center">
                                                                        <img src="<?php echo e(asset('image/Mal.svg')); ?>" alt="Workflow">
                                                                    </div>
                                                        ...
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-center">
                                                            <div class="div-estado-proceso">
                                                                <?php if($pago->fecha_validacion != null): ?>
                                                                    ...
                                                                    <p class="font-bold"><?php echo e($service->formatDate($pago->fecha_validacion)); ?></p>
                                                                <?php else: ?>
                                                                    <div class="flex justify-center items-center">
                                                                        <img src="<?php echo e(asset('image/Mal.svg')); ?>" alt="Workflow">
                                                                    </div>
                                                    ...
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-center">
                                                            <div class="div-estado-proceso">
                                                                <?php if($pago->fecha_pago != null): ?>
                                                                    <div class="flex justify-center">
                                                                        <img src="<?php echo e(asset('image/Bien.svg')); ?>" alt="Workflow">
                                                                    </div>
                                                                    <p class="font-bold"><?php echo e($service->formatDate($pago->fecha_pago)); ?></p>
                                                                <?php else: ?>
                                                                    <div class="flex justify-center">
                                                                        <img src="<?php echo e(asset('image/Mal.svg')); ?>" alt="Workflow">
                                                                    </div>
                                                    ...
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 flex">
                                                            ...
                                                            <a type="button" href="<?php echo e(route('show_pagos', $pago->id_desglose_pagos)); ?>" class="bg-white text-sm text-blue-500 font-normal text-ms p-2 rounded rounded-lg">Detalles</a>
                    ...
                    <div class="tab_content" id="tab3">
                        ...
                        <div class="">
                            ...
                            <?php if($obj_obra->get('obra')->monto_modificado==null?$total_pagado->total_estimacion<$obj_obra->get('obra')->monto_contratado:$total_pagado->total_estimacion<$obj_obra->get('obra')->monto_modificado): ?>
                                <div class="flex justify-center">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $estimaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $estimacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-center">
                                                            <?php echo e($estimacion->numero_estimacion); ?>

                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-right">
                                                            <?php echo e($service->formatNumber($estimacion->total_estimacion)); ?>

                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-right">
                                                            <?php echo e($service->formatNumber($estimacion->supervicion_obra + $estimacion->mano_obra + $estimacion->cinco_millar + $estimacion->dos_millar)); ?>

                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-right">
                                                            <?php echo e($service->formatNumber($estimacion->amortizacion_anticipo)); ?>

                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-right">
                                                            <b><?php echo e($service->formatNumber($estimacion->total_estimacion - ($estimacion->supervicion_obra + $estimacion->mano_obra + $estimacion->cinco_millar + $estimacion->dos_millar + $estimacion->amortizacion_anticipo))); ?></b>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 text-right">
                                                        Del <b><?php echo e($service->formatDate($estimacion->fecha_inicio)); ?></b><br>
                                                        Al <b><?php echo e($service->formatDate($estimacion->fecha_final)); ?></b>
                                                        </div>
                                                    </td>
                                                    
                                                    <td>
                                                        <?php if($estimacion->total_estimacion == null): ?>
                                                            <div class="text-sm leading-5 font-medium text-gray-900 flex justify-center">
                                                                <button type="button" href="" class="bg-white text-sm text-blue-500 font-normal text-ms p-2 rounded rounded-lg" onclick="toggleModal_2('modal-agregar-estimacion-edit', <?php echo e($estimacion); ?>)">Editar</button>
                                                            </div>
                                                        <?php endif; ?>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900">
                                                            <?php echo e($convenio->numero_convenio_modificatorio); ?>

                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900">
                                                            <?php echo e($service->formatDate($convenio->fecha_convenio)); ?>
                                                            ...
                                                            <p>
                                                                <?php switch($convenio->tipo):
                                                                    case ("Convenio modificatorio al monto del contrato"): ?>
                                                                        Monto modificado: <br><b><?php echo e($service->formatNumber($convenio->monto_modificado)); ?></b>
                                                                    <?php break; ?>
                                                                    <?php case ("Convenio modificatorio a la fecha del contrato"): ?>
                                                                        Fecha modificada: <br><b><?php echo e($service->formatDate($convenio->fecha_fin_modificada)); ?></b>
                                                                    <?php break; ?>

                                                                    <?php case ("Convenio modificatorio a las metas del contrato"): ?>
                                                                        Se ha modificado las metas iniciales del contrato.
                                                                    <?php break; ?>

                                                                    <?php case ("Convenio modificatorio al monto y fecha de contrato"): ?>
                                                                        Monto modificado: <br><b><?php echo e($service->formatNumber($convenio->monto_modificado)); ?></b>
                                                                    <?php break; ?>

                                                                    <?php case ("Convenio modificatorio al monto y metas de contrato"): ?>
                                                                        Monto modificado: <br><b><?php echo e($service->formatNumber($convenio->monto_modificado)); ?></b>
                                                                    <?php break; ?>

                                                                    <?php case ("Convenio modificatorio a la fecha y metas de contrato"): ?>
                                                                        Fecha modificada: <br><b><?php echo e($service->formatDate($convenio->fecha_fin_modificada)); ?></b>
                                                                    <?php break; ?>

                                                                    
                                                                    <?php default: ?>
                                                                        Monto modificado: <br><b><?php echo e($service->formatNumber($convenio->monto_modificado)); ?></b><br>
                                                                        Fecha modificada: <br><b><?php echo e($service->formatDate($convenio->fecha_fin_modificada)); ?></b>
                                                                <?php endswitch; ?>
                                                            </p>
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="text-sm leading-5 font-medium text-gray-900 flex">
                                                            <?php if($key == count($convenios) - 1): ?>
                                                                <button type="button" href="" class="bg-white text-sm text-blue-500 font-normal text-ms p-2 rounded rounded-lg" onclick="toggleModal_1('modal-edit', <?php echo e($convenio); ?>)">Editar</button>
                                                            <?php endif; ?>
                                                        </div>
                                                    </td>
                                                </tr>
...
<?php if($obj_obra->get('obra')->modalidad_ejecucion == 2): ?>
    ...
    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal">
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <!--body-->
            <form action="<?php echo e(route('create_convenio')); ?>" method="POST" id="formulario_convenio" name="formulario_convenio">
            <?php echo csrf_field(); ?>
            <?php echo method_field('POST'); ?>
            <div class="relative p-6 flex-auto">
                <div class="grid grid-cols-10 gap-4">
                    <input type="text" name="id_obra" id="id_obra" maxlength="40" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obj_obra->get('obra')->id_obra); ?>">
                    <div class="col-span-5 sm:col-span-5 ">
                        <label for="contrato" class="block text-sm font-semibold text-gray-700">Número de convenio*</label>
                        <input type="text" name="numero_convenio_modificatorio" id="numero_convenio_modificatorio" maxlength="40" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('oficio_notificacion')); ?>">
                    ...
                    <div class="col-span-5">
                        ...
                        <input type="date" name="fecha_convenio" id="fecha_convenio" min="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>" max="<?php echo e($obj_obra->get('obra')->fecha_final_real); ?>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" >
                    ...
                    <div id="mod_fecha_fin" class="hidden col-span-5">
                        ...
                        <input type="date" name="fecha_fin_modificada" id="fecha_fin_modificada" min="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>" max="<?php echo e($obj_obra->get('obra')->ejercicio +1); ?>-03-31" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" >
    ...
    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-edit">
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <!--body-->
            <form action="<?php echo e(route('update_convenio')); ?>" method="POST" id="formulario_convenio_edit" name="formulario_convenio_edit">
            <?php echo csrf_field(); ?>
            <?php echo method_field('POST'); ?>
            <div class="relative p-6 flex-auto">
                <div class="grid grid-cols-10 gap-4">
                    ...
                    <div class="col-span-5 sm:col-span-5 ">
                        ...
                        <input type="text" name="numero_convenio_modificatorio_edit" id="numero_convenio_modificatorio_edit" maxlength="40" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('oficio_notificacion')); ?>">
                        <label id="error_numero_convenio_modificatorio" class="hidden text-base font-normal text-red-500" >Ingrese un número de convenio valido</label>
                    </div>
                    <div class="col-span-3 sm:col-span-5">
                    ...
                    <div class="col-span-5">
                        ...
                        <input type="date" name="fecha_convenio_edit" id="fecha_convenio_edit" min="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>" max="<?php echo e($obj_obra->get('obra')->fecha_final_real); ?>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" >
                    ...
                    <div id="mod_fecha_fin_edit" class="col-span-5">
                        ...
                        <input type="date" name="fecha_fin_modificada_edit" id="fecha_fin_modificada_edit" min="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>" max="<?php echo e($obj_obra->get('obra')->ejercicio +1); ?>-03-31" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" >
                    ...
                    <div id="monto_modificado_edit_div" class="col-span-8 sm:col-span-5">
                        ...
                        <label id="error_monto_edit" name="error_monto_edit" class="hidden text-base font-normal text-red-500" >El monto a modificar es mayor que el ejercicido <?php echo e($service->formatNumber($total_pagado->total_obra + $obj_obra->get('obra')->anticipo_monto)); ?></label>
                    </div>
            </div>
    ...
    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-agregar-estimacion">
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <!--body-->
            <form action="<?php echo e(route('create_estimacion')); ?>" method="POST" id="formulario_create_estimacion" name="formulario_create_estimacion">
            <?php echo csrf_field(); ?>
            <?php echo method_field('POST'); ?>
            <div class="relative p-6 flex-auto">
                <div class="grid grid-cols-9 gap-4">
                    <input type="text" name="id_obra_contrato" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obj_obra->get('contrato')->obra_contrato_id); ?>">
                    <div class="col-span-2 sm:col-span-3 ">
                        <label for="contrato" class="block text-sm font-bold text-gray-700">Número de estimación*</label>
                        <div class="mt-1 py-2 px-3">
                            <label id="label_numero_estimacion" class="text-base"><?php echo e(count($estimaciones) + 1); ?></label>
                        </div>  
                        <input type="text" name="numero_estimacion" id="numero_estimacion" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(count($estimaciones) + 1); ?>">
                    ...
                    <div class="col-span-4">
                        ...
                        <input type="date" name="fecha_recepcion" id="fecha_recepcion" min="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>" max="<?php echo e($obj_obra->get('obra')->fecha_final_real); ?>" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('fecha_oficio_notificacion')); ?>">
                    ...
                    <div class="col-span-10">
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            <div class="col-span-2">
                                <input type="date" name="fecha_inicio_estimacion" id="fecha_inicio_estimacion" min="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>" max="<?php echo e($obj_obra->get('obra')->fecha_final_real); ?>" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('fecha_oficio_notificacion')); ?>">
                            ...
                            <div class="col-span-2">
                                <input type="date" name="fecha_fin_estimacion" id="fecha_fin_estimacion" min="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>" max="<?php echo e($obj_obra->get('obra')->fecha_final_real); ?>"  class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('fecha_oficio_notificacion')); ?>">
                    ...
                    <div class="col-span-8 md:col-span-5">
                        ...
                        <input type="text" name="folio_factura" id="folio_factura" maxlength="36" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('oficio_notificacion')); ?>">
    ...
    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-agregar-estimacion-edit">
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <!--body-->
            <form action="<?php echo e(route('update_estimacion')); ?>" method="POST" id="formulario_create_estimacion_edit" name="formulario_create_estimacion_edit">
            <?php echo csrf_field(); ?>
            <?php echo method_field('POST'); ?>
            <div class="relative p-6 flex-auto">
                <div class="grid grid-cols-9 gap-4">
                    ...
                    <div class="col-span-2 sm:col-span-2 ">
                        <label for="contrato" class="block text-sm font-bold text-gray-700">Número de estimación*</label>
                        <div class="mt-1 py-2 px-3">
                            <label id="label_numero_estimacion_edit" class="text-base"><?php echo e(count($estimaciones) + 1); ?></label>
                        </div>  
                        <input type="text" name="numero_estimacion_edit" id="numero_estimacion_edit" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(count($estimaciones) + 1); ?>">
                    ...
                    <div class="col-span-4">
                        <label for="fecha_recepcion" class="block text-sm font-bold text-gray-700">Fecha de recepción de documentos*</label>
                        <input type="date" name="fecha_recepcion_edit" id="fecha_recepcion_edit" min="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>" max="<?php echo e($obj_obra->get('obra')->ejercicio+1); ?>-03-31" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('fecha_oficio_notificacion')); ?>">
                    ...
                    <div class="col-span-9">
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            <div class="col-span-2">
                                <input type="date" name="fecha_inicio_estimacion_edit" id="fecha_inicio_estimacion_edit" min="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>" max="<?php echo e($obj_obra->get('obra')->ejercicio+1); ?>-03-31" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('fecha_oficio_notificacion')); ?>">
                            ...
                            <div class="col-span-2">
                                <input type="date" name="fecha_fin_estimacion_edit" id="fecha_fin_estimacion_edit" min="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>" max="<?php echo e($obj_obra->get('obra')->ejercicio+1); ?>-03-31"  class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('fecha_oficio_notificacion')); ?>">
    ...
    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-update-pago">
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <!--body-->
            <form action="<?php echo e(route('create_estimacion')); ?>" method="POST" id="formulario_update_pago" name="formulario_update_pago">
            <?php echo csrf_field(); ?>
            <?php echo method_field('POST'); ?>
            <div class="relative p-6 flex-auto">
                <div class="grid grid-cols-10 gap-4">
...
<?php if($obj_obra->get('obra')->modalidad_ejecucion == 1): ?>
    ...
    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-lista-raya">
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <!--body-->
            <form action="<?php echo e(route('store_lista')); ?>" method="POST" id="formulario_lista" name="formulario_lista">
            <?php echo csrf_field(); ?>
            <?php echo method_field('POST'); ?>
            <div class="relative p-6 flex-auto">
                <div class="grid grid-cols-10 gap-4">
                    <input type="text" name="id_obra_admin_lista" id="id_obra_admin_lista" maxlength="40" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obj_obra->get('admin')->obra_administracion_id); ?>">
                    <input type="text" name="id_obra_lista" id="id_obra_lista" maxlength="40" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obj_obra->get('obra')->id_obra); ?>">
                    <div class="col-span-5 sm:col-span-5 ">
                        <label for="contrato" class="block text-sm font-bold text-gray-700">Número de lista de raya*</label>
                        <div class="mt-1 py-2 px-3">
                            <label id="label_numero_lista_raya" class="text-base"><?php echo e(str_pad(count($listas_raya) + 1,3,"0",STR_PAD_LEFT)); ?></label>
                        </div>  
                        <input type="text" name="numero_lista_raya" id="numero_lista_raya" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(count($listas_raya) + 1); ?>">
                    ...
                    <div class="col-span-10">
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            <div class="col-span-2">
                                <input type="date" name="fecha_inicio_lista" id="fecha_inicio_lista" min="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>" max="<?php echo e($obj_obra->get('obra')->fecha_final_real); ?>" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('fecha_oficio_notificacion')); ?>">
                            ...
                            <div class="col-span-2">
                                <input type="date" name="fecha_fin_lista" id="fecha_fin_lista" min="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>" max="<?php echo e($obj_obra->get('obra')->fecha_final_real); ?>"  class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('fecha_oficio_notificacion')); ?>">
    ...
    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-lista-raya-edit">
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <!--body-->
            <form action="<?php echo e(route('update_lista')); ?>" method="POST" id="formulario_lista_edit" name="formulario_lista_edit">
            <?php echo csrf_field(); ?>
            <?php echo method_field('POST'); ?>
            <div class="relative p-6 flex-auto">
                <div class="grid grid-cols-10 gap-4">
                    ...
                    <input type="text" name="id_obra_lista_edit" id="id_obra_lista_edit" maxlength="40" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obj_obra->get('obra')->id_obra); ?>">
                    <div class="col-span-5 sm:col-span-5 ">
                        <label for="contrato" class="block text-sm font-bold text-gray-700">Número de lista de raya*</label>
                        <div class="mt-1 py-2 px-3">
                            <label id="label_numero_lista_raya_edit" class="text-base"><?php echo e(str_pad(count($listas_raya) + 1,3,"0",STR_PAD_LEFT)); ?></label>
                        </div>  
                        <input type="text" name="numero_lista_raya_edit" id="numero_lista_raya_edit" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(count($listas_raya) + 1); ?>">
                    ...
                    <div class="col-span-10">
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            <div class="col-span-2">
                                <input type="date" name="fecha_inicio_lista_edit" id="fecha_inicio_lista_edit" min="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>" max="<?php echo e($obj_obra->get('obra')->fecha_final_real); ?>" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('fecha_oficio_notificacion')); ?>">
                            ...
                            <div class="col-span-2">
                                <input type="date" name="fecha_fin_lista_edit" id="fecha_fin_lista_edit" min="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>" max="<?php echo e($obj_obra->get('obra')->fecha_final_real); ?>"  class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('fecha_oficio_notificacion')); ?>">
    ...
    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-agregar-factura">
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <!--body-->
            <form action="<?php echo e(route('store_factura')); ?>" method="POST" id="formulario_factura" name="formulario_factura">
            <?php echo csrf_field(); ?>
            <?php echo method_field('POST'); ?>
            <div class="relative p-6 flex-auto">
                <div class="grid grid-cols-10 gap-4">
                    <input type="text" name="id_obra_admin_factura" id="id_obra_admin_factura" maxlength="40" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obj_obra->get('admin')->obra_administracion_id); ?>">
                    <input type="text" name="id_obra_factura" id="id_obra_factura" maxlength="40" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obj_obra->get('obra')->id_obra); ?>">
                    <div class="col-span-10 sm:col-span-5">
                        ...
                        <input type="text" name="folio_fiscal_factura" id="folio_fiscal_factura" maxlength="36" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('oficio_notificacion')); ?>">
                    ...
                    <div class="col-span-5 sm:col-span-5">
                        ...
                        <label id="error_monto_admin_mayor_fac" class="hidden text-base font-normal text-red-500" >El monto es mayor que el restante de la obra: <?php echo e($service->formatNumber($obj_obra->get('obra')->monto_contratado - $total_admin)); ?></label>
                    ...
                    <div class="col-span-10">
                        ...
                        <textarea maxlength ="300" name="concepto_factura" id="concepto_factura" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('fecha_oficio_notificacion')); ?>"></textarea>
                    ...
                    <div class="col-span-10">
                        ...
                        <select class="js-example-basic-single mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" name="proveedor_id">
                            <?php $__currentLoopData = $proveedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proveedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($proveedor->id_proveedor); ?>"><?php echo e($proveedor->rfc); ?> - <?php echo e($proveedor->razon_social); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
    ...
    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-edit-factura">
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <!--body-->
            <form action="<?php echo e(route('update_factura')); ?>" method="POST" id="formulario_factura_edit" name="formulario_factura_edit">
            <?php echo csrf_field(); ?>
            <?php echo method_field('POST'); ?>
            <div class="relative p-6 flex-auto">
                <div class="grid grid-cols-10 gap-4">
                    ...
                    <input type="text" name="id_obra_factura_edit" id="id_obra_factura_edit" maxlength="40" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obj_obra->get('obra')->id_obra); ?>">
                    <div class="col-span-10 sm:col-span-5">
                        <label  id="label_folio_fiscal_factura_edit" class="block text-sm font-bold text-gray-700">Folio fiscal:</label>
                        <input type="text" name="folio_fiscal_factura_edit" id="folio_fiscal_factura_edit" maxlength="36" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('oficio_notificacion')); ?>">
                    ...
                    <div class="col-span-5">
                        ...
                        <input type="date" name="fecha_factura_edit" id="fecha_factura_edit" min="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>" max="<?php echo e($obj_obra->get('obra')->fecha_final_real); ?>" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('fecha_oficio_notificacion')); ?>">
                    ...
                    <div class="col-span-5 sm:col-span-5">
                        ...
                        <label id="error_monto_admin_mayor_fac_edit" class="hidden text-base font-normal text-red-500" >El monto es mayor que el restante de la obra: <?php echo e($service->formatNumber($obj_obra->get('obra')->monto_contratado - $total_admin)); ?></label>
                    ...
                    <div class="col-span-10">
                        ...
                        <textarea maxlength ="300" name="concepto_factura_edit" id="concepto_factura_edit" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('fecha_oficio_notificacion')); ?>"></textarea>
    ...
    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-agregar-contrato">
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <!--body-->
            <form action="<?php echo e(route('store_contrato')); ?>" method="POST" id="formulario_contrato" name="formulario_contrato">
            <?php echo csrf_field(); ?>
            <?php echo method_field('POST'); ?>
            <div class="relative p-6 flex-auto">
                <div class="grid grid-cols-10 gap-4">
                    <input type="text" name="id_obra_admin_contrato" id="id_obra_admin_contrato" maxlength="40" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obj_obra->get('admin')->obra_administracion_id); ?>">
                    <input type="text" name="id_obra_contrato" id="id_obra_contrato" maxlength="40" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obj_obra->get('obra')->id_obra); ?>">
                    <div class="col-span-10 sm:col-span-5">
                        <label  id="label_numero_contrato" class="block text-sm font-bold text-gray-700">Número de contrato:*</label>
                        <input type="text" name="numero_contrato" id="numero_contrato" maxlength="36" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('oficio_notificacion')); ?>">
                    ...
                    <div class="col-span-5">
                        ...
                        <input type="date" name="fecha_contrato" id="fecha_contrato" min="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>" max="<?php echo e($obj_obra->get('obra')->fecha_final_real); ?>" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('fecha_oficio_notificacion')); ?>">
                    ...
                    <div class="col-span-5 sm:col-span-5">
                        ...
                        <label id="error_monto_admin_mayor_contrato" class="hidden text-base font-normal text-red-500" >El monto es mayor que el restante de la obra: <?php echo e($service->formatNumber($obj_obra->get('obra')->monto_contratado - $total_admin)); ?></label>
                    ...
                    <div class="col-span-10">
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            <div class="col-span-2">
                                <input type="date" name="fecha_inicio_contrato" id="fecha_inicio_contrato" min="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>" max="<?php echo e($obj_obra->get('obra')->fecha_final_real); ?>" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('fecha_oficio_notificacion')); ?>">
                            ...
                            <div class="col-span-2">
                                <input type="date" name="fecha_fin_contrato" id="fecha_fin_contrato" min="<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>" max="<?php echo e($obj_obra->get('obra')->fecha_final_real); ?>"  class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('fecha_oficio_notificacion')); ?>">
...
<?php endif; ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            observaciones_datos = "<?php echo e(str_replace("\r\n","  --  ", $observaciones?$observaciones->observacion:'\r\n')); ?>";
        ...
        $(document).ready(function() {
            ...
            $("#total_lista_raya").on({
                "keyup": function(event) {
                    ...
                    total = <?php echo e($total_admin==''?0:$total_admin); ?>;
                    total_obra = <?php echo e($obj_obra->get('obra')->monto_contratado); ?>;
        ...
        $(document).ready(function() {
            ...
            $('#fecha_inicio').change(function() {
                ...
                if(fecha != "Invalid Date"){
                    ...
                    if($(this).val() != '<?php echo e($obj_obra->get('obra')->ejercicio); ?>-12-31') {
                        fecha.setDate(fecha.getDate() + 1);
                    }
            ...
            $("#guardar").click(function () {
                ...
                monto_ejercido = <?php echo e($total_pagado->total_obra); ?> + <?php echo e($obj_obra->get('obra')->anticipo_monto); ?>;
            ...
            $("#total_estimacion").on({
                ...
                "keyup": function(event) {
                    ...
                    console.log()
                    monto_restante = <?php echo e($obj_obra->get('obra')->monto_modificado?$obj_obra->get('obra')->monto_modificado:$obj_obra->get('obra')->monto_contratado); ?> - <?php echo e($total_pagado->total_estimaciones?$total_pagado->total_estimaciones:0); ?>;
            ...
            $('#fecha_inicio_estimacion').change(function() {
                ...
                fecha_final = new Date('<?php echo e($obj_obra->get('obra')->fecha_final_real); ?>');
            ...
            $('#fecha_fin_estimacion').change(function() {
                ...
                fecha = new Date($(this).val());
                fecha.setDate(fecha.getDate() - 30);
                fecha_inicio = new Date('<?php echo e($obj_obra->get('obra')->fecha_inicio_programada); ?>');
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Nueva carpeta (2)\CMR\Sistema\cmr_app\resources\views/obra/ver.blade.php ENDPATH**/ ?>