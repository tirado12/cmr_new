...
<?php $__env->startSection('title','Editar Fuente financiamiento'); ?>
...
<div class="mt-10 sm:mt-0 shadow-2xl bg-white rounded-lg">
      ...
      <div class="mt-5 md:mt-0 md:col-span-2">
        <form action="<?php echo e(route('fuenteCliente.update', $fuenteCliente)); ?>" method="POST" id="formulario" name="formulario">
          <?php echo csrf_field(); ?>
            ...
            <div class="px-4 py-5 bg-white sm:p-6"> 
              <div class="grid grid-cols-10 gap-6">
                ...
                <div class="col-span-7 lg:col-span-4">
                  ...
                  <label id="label_municipio" for="monto_comprometido" class="block text-base font-medium text-gray-700 py-3 px-2"><?php echo e($cliente[0]->nombre); ?></label>
                </div>

                <div class="col-span-3 lg:col-span-2">
                  <label for="ejercicio" class="block text-sm font-medium text-gray-700">Ejercicio</label>
                  <label id="label_ejercicio" for="monto_comprometido" class="block text-base font-medium text-gray-700 py-3 px-2"><?php echo e($fuenteCliente->ejercicio); ?></label>
                </div>
                ...
                <div class="col-span-10 lg:col-span-2">
                  ...
                  <div class="relative ">
                    ...
                    <input type="text" name="monto_proyectado" id="monto_proyectado" class="pl-7 mt-1 text-base focus:ring-indigo-500 focus:border-indigo-500 block text-gray-700 w-full shadow-sm border-gray-300 rounded-md myDIV" value="<?php echo e($service->formatNumber($fuenteCliente->monto_proyectado)); ?>" onclick="">
                  </div>
                ...
                <div class="col-span-10 lg:col-span-2">
                    ...
                    <div class="relative ">
                      ...
                      <input type="text" name="monto_comprometido" id="monto_comprometido" class="pl-7 mt-1 text-base focus:ring-indigo-500 focus:border-indigo-500 block text-gray-700 w-full border-none myDIV" disabled value="<?php echo e($service->formatNumber($fuenteCliente->monto_comprometido)); ?>" onclick="">
                    </div>
                </div>
                
                <?php if($fuenteCliente->fuente_financiamiento_id == 2): ?>
                <div class="col-span-10 lg:col-span-2">
                    ...
                    <input type="date" name="acta_integracion_consejo" id="acta_integracion_consejo" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($fuenteCliente->acta_integracion_consejo); ?>">
                ...
                <div class="col-span-10 lg:col-span-2">
                    ...
                    <input type="date" name="acta_priorizacion" id="acta_priorizacion" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($fuenteCliente->acta_priorizacion); ?>">
                ...
                <div class="col-span-10 lg:col-span-2">
                    ...
                    <input type="date" name="adendum_priorizacion" id="adendum_priorizacion" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($fuenteCliente->adendum_priorizacion); ?>">
                    ...
                    <select id="fuente_financiamiento_id" name="fuente_financiamiento_id" class="clickable mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" >                
                      <?php if(auth()->check() && auth()->user()->hasRole('Administrador')): ?>
                        <?php $__currentLoopData = $fuentes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fuente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($fuente->id_fuente_financiamiento); ?>" <?php echo e(($fuente->id_fuente_financiamiento == $fuenteCliente->fuente_financiamiento_id) ? 'selected' : ''); ?>> <?php echo e($fuente->nombre_corto); ?> </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      <?php endif; ?>
                      <?php if(auth()->check() && auth()->user()->hasRole('Usuario')): ?>
                        <option value="<?php echo e($fuenteCliente->fuente_financiamiento_id); ?>" selected> <?php echo e($fuentes->where('id_fuente_financiamiento', $fuenteCliente->fuente_financiamiento_id )->first()->nombre_corto); ?></option>
                      <?php endif; ?>
                    </select>
                ...
                <div class="col-span-10 lg:col-span-2">
                  <?php if($fuenteCliente->fuente_financiamiento_id == 2): ?>
                    <div>
                      <label for="cbox2" class="text-sm font-medium text-gray-700"><input type="checkbox" id="prodim" name="prodim" <?php echo e(($fuenteCliente->prodim == 1) ? 'checked' : ''); ?>> PRODIMDF</label><br>
                      <label for="cbox2" class="text-sm font-medium text-gray-700"><input type="checkbox" id="gastos_indirectos" name="gastos_indirectos" <?php echo e(($fuenteCliente->gastos_indirectos == 1) ? 'checked' : ''); ?>> Gastos indirectos</label>
                    </div>
                  <?php endif; ?>
...
//colocar opcion registrada en los selected
    $(document).ready(function(){
      ...
      var statusProdim =  '<?php echo e($fuenteCliente->prodim); ?>';
      var statusGastos =  '<?php echo e($fuenteCliente->gastos_indirectos); ?>';
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Documentos\CMR\Creatividad\Sistema\cmr_app\resources\views/fuentes_clientes/edit.blade.php ENDPATH**/ ?>