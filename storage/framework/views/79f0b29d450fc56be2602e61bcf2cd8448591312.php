...
<?php $fuentes = app('App\Http\Controllers\ObraController'); ?>
<?php $__env->startSection('contenido'); ?>
    ...
    <div class="flex flex-col mt-6">
        <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
          <a type="button"  href="<?php echo e(route('obra.create')); ?>" class="bg-orange-800 mb-4 text-white active:bg-orange-800 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">Agregar</a>
            <!-- div de tabla -->
        </div>
    </div>
              ...
              <?php $__currentLoopData = $obras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $obra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <tr>
                      <td>
                        ...
                        <?php echo e($obra_1->find($obra->id_obra)->nombre_municipio); ?>

                        </div>
                      </td>
                      <td>
                        <div class="text-sm leading-5 font-medium text-gray-900">
                          <?php echo e($obra -> nombre); ?>
                      ...
                      <td>
                        ...
                        <?php echo e($service->formatNumber($obra -> monto_contratado)); ?></p>
                        </div>
                      ...
                      <td>
                        <div class="text-sm leading-5 font-medium text-gray-900">
                        <p>
                        <?php echo e($obra_1->groupBy('id_obra')->get("$obra->id_obra")->implode('nombre', ' - ')); ?>
                      ...
                      <td>
                        <div class="text-sm leading-5 font-medium text-gray-900">
                        <?php if($obra -> obra_contrato_id == null): ?><?php echo e("Administración directa"); ?><?php endif; ?>
                          <?php if($obra -> obra_contrato_id != null): ?><?php echo e("Contrato"); ?><?php endif; ?>
                        </div>
                      </td>

                      <td>
                        <div class="flex justify-center">
                        <form action="<?php echo e(route('obra.destroy', $obra->id_obra)); ?>" method="POST" class="form-eliminar" >
                          <div>
                          <a type="button"  href="<?php echo e(route('obra.edit', $obra->id_obra)); ?>" class="bg-white text-sm text-blue-500 font-normal text-ms p-2 rounded rounded-lg">Editar</a>
                          <a type="button"  href="<?php echo e(route('obra.show', $obra->id_obra)); ?>" class="bg-white text-sm text-blue-500 font-normal text-ms p-2 rounded rounded-lg">Detalles</a>
...
<div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-add">
  <div class="relative w-auto my-6 mx-auto max-w-3xl">
    ...
    <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
      ...
      <!--body-->
      <form action="<?php echo e(route('obra.store', $obra->id)); ?>" method="POST" accept-charset="UTF-8" enctype="multipart/form-data" id="form-ajax">
        <?php echo csrf_field(); ?>
      ...
      <div class="relative p-6 flex-auto">
          ...
          <div class="grid grid-cols-8 gap-4">
            <div class="col-span-8 ">
              ...
              <input type="text" onKeyUp="this.value=this.value.toLowerCase();" name="user" id="user" autocomplete="given-name" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required value="<?php echo e(old('user')); ?>">
            ...
            <div class="col-span-8">
              ...
              <input type="text" name="email" id="email" autocomplete="email" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('email')); ?>">
            ...
            <div class="col-span-8">
              ...
              <input type="password" name="password" id="password"  class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('password')); ?>">
            ...
            <div id="div_confirmacion" class="hidden col-span-8">
              ...
              <input type="password" name="password_confirmation" id="password_confirmation"  class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('password')); ?>">
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Nueva carpeta (2)\CMR\Sistema\cmr_app\resources\views/obra/index.blade.php ENDPATH**/ ?>