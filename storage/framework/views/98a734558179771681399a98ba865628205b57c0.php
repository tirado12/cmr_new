        ...
        <form action="<?php echo e(route('store_obra')); ?>" method="POST" accept-charset="UTF-8" enctype="multipart/form-data" id="formulario">
                    ...
                    <div class="grid grid-cols-8 gap-6 mt-10">
                        ...
                        <div class="col-span-8 md:col-span-2 solo_contrato">
                            ...
                            <div class="relative ">
                                ...
                                <input type="text" name="anticipo_porcentaje" id="anticipo_porcentaje" minlength="1" maxlength="2" class="pr-7  mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="0">
                            </div>
                ...
                <div id="datos_generales" style="display: none;">
                    ...
                    <div class="grid grid-cols-8 gap-8 mt-10">
                        ...
                        <div class="col-span-10 md:col-span-5">
                            ...
                            <input type="text" name="nombre_obra" id="nombre_obra" maxlength="500" autocomplete="nombre_obra" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required value="<?php echo e(old('nombre_obra')); ?>">
                        ...
                        <div class="col-span-10 md:col-span-3">
                            ...
                            <input type="text" maxlength="100" name="nombre_corto" id="nombre_corto" autocomplete="nombre_corto" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('nombre_corto')); ?>">
            ...
            <div class="mt-10 p-4 border-t border-solid border-blueGray-200 rounded-b">
                ...
                <div class="text-right">
                    ...
                    <button id="regresar" type="button" class="bg-green-500 text-white active:bg-green-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" onclick="mostrar()">
                        Regresar
                    </button>
...
<script>
    ...
    function ocultar() {
        ...
        if(posicion == 0) {
            ...
            $("#example tr").find('td:eq(0)').each(function () {
                codigo = $(this).find("label").html();
                if(codigo == "Fondo III"){
                    $('#fecha_contrato').attr("min", '<?php echo e($actas_preliminares->acta_priorizacion); ?>');
                    fondo_III = true;
        ...
        if(posicion == 1 && modalidad == 2) {
            ...
            $("#example tr").find('td:eq(0)').each(function () {
                ...
                if(codigo == "Fondo III"){
                    $('#fecha_oficio_notificacion').attr("min", '<?php echo e($actas_preliminares->acta_priorizacion); ?>');
                }else{
        ...
        if(posicion == 1 && modalidad == 1) {
            $("#example tr").find('td:eq(0)').each(function () {
                ...
                if(codigo == "Fondo III"){
                    $('#fecha_inicio').attr("min", '<?php echo e($actas_preliminares->acta_priorizacion); ?>');
                    $('#fecha_fin').attr("min", '<?php echo e($actas_preliminares->acta_priorizacion); ?>');
                    $('#fecha_oficio_notificacion').attr("min", '<?php echo e($actas_preliminares->acta_priorizacion); ?>');
                }else{
                    $('#fecha_oficio_notificacion').attr("min", '<?php echo e($anio); ?>-01-01');
        ...
        if(posicion == 2) {
            ...
            $("#example tr").find('td:eq(0)').each(function () {
                ...
                if(codigo == "Fondo III"){
                    $('#acta_seleccion').attr("max", '<?php echo e($actas_preliminares->acta_priorizacion); ?>');
                    $('#acta_integracion').attr("max", '<?php echo e($actas_preliminares->acta_priorizacion); ?>');
                    $('#convenio_concertacion').attr("max", '<?php echo e($actas_preliminares->acta_priorizacion); ?>');
                    $('#convenio_instancias').attr("max", '<?php echo e($actas_preliminares->acta_priorizacion); ?>');
                }else{
    ...
    $(document).ready(function() {
        ...
        $("#modalidad_ejecucion").css({"display":"none"});
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Nueva carpeta (2)\CMR\Sistema\cmr_app\resources\views/obra/create_user.blade.php ENDPATH**/ ?>