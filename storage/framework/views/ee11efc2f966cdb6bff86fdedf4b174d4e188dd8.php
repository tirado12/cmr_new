...
<?php $__env->startSection('title','Contratistas'); ?>
      ...
      <tr>
          ...
          <td>
            <div class="flex items-center">
              <div>
                  <div class="text-sm leading-5 font-medium text-gray-900"><?php echo e($contratista->razon_social); ?></div>
                  <div class="text-sm leading-5 text-gray-500"><?php echo e($contratista->rfc); ?></div>
              </div>
          </div>
          </td>
          <td>
            <div class="text-sm leading-5 font-medium text-gray-900">
            <?php echo e($contratista->telefono); ?>
          ...
          <td>
            ...
            <form action="<?php echo e(route('contratistas.destroy', $contratista->id_contratista)); ?>" method="POST" class="form-eliminar" >
              <div>
              <a type="button"  href="<?php echo e(route('contratistas.edit', $contratista->id_contratista)); ?>" class="bg-white text-blue-500 p-2 rounded rounded-lg">Editar</a>
...
<div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-id">
  <div class="relative w-auto my-6 mx-auto max-w-3xl">
    ...
    <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
      ...
      <!--body-->
      <form action="<?php echo e(route('contratistas.store')); ?>" method="POST" id="formulario" name="formulario">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Documentos\CMR\Creatividad\Sistema\cmr_app\resources\views/contratistas/index.blade.php ENDPATH**/ ?>