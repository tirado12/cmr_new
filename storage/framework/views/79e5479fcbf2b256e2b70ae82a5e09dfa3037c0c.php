    ...
    <div class="mt-6 p-8 shadow-2xl bg-white rounded-lg">
        ...
        <div class="mt-5 grid grid-cols-9 gap-4">
            <div class="col-span-9">
                <p class="font-bold"><?php echo e($obra->nombre_obra); ?></p>
            </div>
            <div class="col-span-9">
                <p class="text-sm font-semibold">Nombre corto: <br><span class="ml-5 text-base font-bold mostrar_datos"><?php echo e($obra->nombre_corto_obra); ?></span></p>
            </div>
            <div class="col-span-9 sm:col-span-3">
                <p class="text-sm font-semibold">Localidad <br><span class="ml-5 text-base font-bold"><?php echo e($obra->nombre_localidad); ?></span></p>
            </div>
            <div class="col-span-9 sm:col-span-2">
                <p class="text-sm font-semibold">Municipio <br><span class="ml-5 text-base font-bold"><?php echo e($obra->nombre_municipio); ?></span></p>
            </div>
            <div class="col-span-9 sm:col-span-2">
                <p class="text-sm font-semibold">Distrito <br><span class="ml-5 text-base font-bold"><?php echo e($obra->nombre_distrito); ?></span></p>
            </div>
            <div class="col-span-9 sm:col-span-2">
                <p class="text-sm font-semibold">Estado <br><span class="ml-5 text-base font-bold"><?php echo e($obra->nombre_estado); ?></span></p>
            </div>
        </div>

        <div class="bg-gray-200 mt-5">
            <h2 class="font-bold text-lg text-center">Detalles del proceso de pago <?php echo e($pagos_obra->nombre == 'Anticipo'?'del': 'de la'); ?> <?php echo e($pagos_obra->nombre); ?></h2>
        </div>
        <?php if($pagos_obra->fecha_recepcion == null || $pagos_obra->fecha_validacion == null || $pagos_obra->fecha_pago == null): ?>
        ...
        <div class="mt-5 grid grid-cols-9 gap-4">
            <div class="col-span-9 sm:col-span-3">
                <p class="text-sm font-semibold">Fecha de recepción de documentos: </p>
                    <p class="ml-5 text-base font-bold mostrar_datos"><?php echo e($pagos_obra->fecha_recepcion == null?'Sin registro previo': $service->formatDate($pagos_obra->fecha_recepcion)); ?> </p>
            </div>
            <div class="col-span-9 sm:col-span-3">
                <p class="text-sm font-semibold">Fecha de validación de documentos: </p>
                
                    <?php if( $pagos_obra->fecha_recepcion!= null): ?>
                        <p class="ml-5 text-base font-bold mostrar_datos text-blue-500">
                            <?php echo e($pagos_obra->fecha_validacion == null?'En proceso': $service->formatDate($pagos_obra->fecha_validacion)); ?> 
                        </p>
                    <?php else: ?>
            ...
            <div class="col-span-9 sm:col-span-3">
                <p class="text-sm font-semibold">Fecha de pago <?php echo e($pagos_obra->nombre == 'Anticipo'?'del': 'de la'); ?> <?php echo e($pagos_obra->nombre); ?>: </p>
                <p class="ml-5 text-base font-bold mostrar_datos">
                    <?php if( $pagos_obra->fecha_recepcion != null): ?>
                        <?php if( $pagos_obra->fecha_validacion != null): ?>
                            <?php if($pagos_obra->fecha_pago == null): ?>
                                <p class="ml-5 text-base font-bold mostrar_datos text-blue-500">
                                    En proceso
                                </p>
                            <?php else: ?>
                                <p class="ml-5 text-base font-bold mostrar_datos text-gray-900">
                                    <?php echo e($service->formatDate($pagos_obra->fecha_pago)); ?>
                ...
                <?php if($pagos_obra != null): ?>
                    <div class="">
                        <table id="example" class="table table_estimacion table-striped bg-white" style="width:100%;">
                            ...
                            <tbody>
                                <?php if($pagos_obra->fecha_recepcion != null): ?>
                                    <?php $__currentLoopData = $observaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $observacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <div class="text-sm leading-5 font-medium text-center">
                                                    <?php if( $pagos_obra->fecha_recepcion != null): ?>
                                                        <?php if( $observacion->fecha_observaciones != null): ?>
                                                            <?php if($observacion->fecha_solventacion == null): ?>
                                                                <p class="text-base font-bold mostrar_datos text-blue-500">
                                                                    En proceso
                                                                </p>
                                                            <?php else: ?>
                                                                <p class="text-base font-bold mostrar_datos text-gray-900">
                                                                    <?php echo e($service->formatDate($observacion->fecha_solventacion)); ?>
                                            ...
                                            <td>
                                                <?php if(count($observaciones) - 1 == $key && $observacion->fecha_solventacion == null && $pagos_obra->fecha_recepcion != null): ?>
                                                    <div class="flex justify-center">
                                                        <button type="button" href="" class="text-sm text-blue-500 background-transparent font-semibold outline-none focus:outline-none transition-all duration-150 text-center" onclick="toggleModal('modal', <?php echo e($observacion); ?>, '<?php echo e(count($observaciones) > 1?$observaciones[$key - 1]->fecha_solventacion:$pagos_obra->fecha_recepcion); ?>','<?php echo e($service->formatDate($observacion->fecha_observaciones)); ?>', '<?php echo e($service->formatDate($observacion->fecha_solventacion)); ?>')">Actualizar</button>
                                                    </div>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
        ...
        <?php if($estimacion != null): ?>
            ...
            <div class="mt-5 grid grid-cols-8 gap-4">
                <div class="<?php echo e($obra->anticipo_monto == 0?$estimacion->numero_estimacion == 1? 'col-span-1':'col-span-2':'col-span-2'); ?>">
                    <p class="text-sm font-semibold ">Número de estimación: </p>
                    <p class="ml-5 text-base font-bold mostrar_datos mt-2"><?php echo e($estimacion->numero_estimacion); ?></p>
                </div>
                <div class="<?php echo e($obra->anticipo_monto == 0?$estimacion->numero_estimacion == 1? 'col-span-1':'col-span-2':'col-span-2'); ?>">
                    <p class="text-sm font-semibold text-center">¿Es finiquito? </p>
                    <div class="div-estado-proceso mt-2">
                        <?php if($estimacion->finiquito): ?>
                            <div class="flex justify-center">
                ...
                <?php if($pagos_obra->fecha_pago != null): ?>
                    <div class="col-span-2">
                        ...
                        <p class="ml-5 text-base font-bold mostrar_datos"><?php echo e($estimacion->folio_factura); ?></p>
                    </div>
                    <?php if($obra->anticipo_monto == 0 && $estimacion->numero_estimacion == 1): ?>
                        <div class="col-span-2">
                            <p class="text-sm font-semibold ">Folio de fianza de cumplimiento: </p>
                            <p class="ml-5 text-base font-bold mostrar_datos mt-2"><?php echo e($obra_contrato->factura_anticipo); ?></p>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="col-span-2">
                        ...
                        <p class="ml-5 text-base font-bold mostrar_datos"><?php echo e($service->formatDate($estimacion->fecha_estimacion)); ?></p>
                    </div>
                    <div class="col-span-2">
                        <p class="text-sm font-semibold ">Total de la estimación: </p>
                        <p class="ml-5 text-base font-bold mostrar_datos"><?php echo e($service->formatNumber($estimacion->total_estimacion)); ?></p>
                    </div>
                    <div class="col-span-2">
                        <p class="text-sm font-semibold">Neto pagado: </p>
                        <p class="ml-5 text-base font-bold mostrar_datos"><?php echo e($service->formatNumber($estimacion->total_estimacion - $estimacion->supervicion_obra - $estimacion->mano_obra - $estimacion->cinco_millar - $estimacion->dos_millar - $estimacion->amortizacion_anticipo)); ?></p>
                    </div>
                ...
                <div class="col-span-4">
                    ...
                    <div class="grid grid-cols-4 gap-4">
                        ...
                        <div class="col-span-2">
                            <p class="text-base font-bold mostrar_datos text-center"><?php echo e($service->formatDate($estimacion->fecha_inicio)); ?></p>
                            <p class="text-sm font-semibold text-center">Fecha inicial </p>
                        </div>
                        <div class="col-span-2">
                            <p class="text-base font-bold mostrar_datos text-center"><?php echo e($service->formatDate($estimacion->fecha_final)); ?></p>
                    ...
                    <div class="col-span-8 border">
                        ...
                        <div class="grid grid-cols-9 gap-4 m-1">
                            ...
                            <div class="col-span-3">
                                <p class="text-base font-bold text-center"><?php echo e($service->formatNumber($estimacion->supervicion_obra)); ?></p>
                                <p class="text-sm font-semibold text-center">Supervición de obra </p>
                            </div>
                            <div class="col-span-3">
                                
                                <p class="text-base font-bold text-center"><?php echo e($service->formatNumber($estimacion->mano_obra)); ?></p>
                                <p class="text-sm font-semibold text-center">Mano de obra</p>
                            </div>
                            <div class="col-span-3">
                                <p class="text-base font-bold text-center"><?php echo e($service->formatNumber($estimacion->cinco_millar)); ?></p>
                                <p class="text-sm font-semibold text-center">Cinco al millar</p>
                            </div>
                            <div class="col-span-3">
                                <p class="text-base font-bold text-center"><?php echo e($service->formatNumber($estimacion->dos_millar)); ?></p>
                                <p class="text-sm font-semibold text-center">Dos al millar</p>
                            </div>
                            <?php if($obra->anticipo_monto > 0): ?>
                                <div class="col-span-3">
                                    <p class="text-base font-bold text-center"><?php echo e($service->formatNumber($estimacion->amortizacion_anticipo)); ?></p>
        ...
        <?php endif; ?>
        <?php if($pagos_obra->nombre == 'Anticipo' && $pagos_obra->fecha_pago != null): ?>
            <div class="bg-gray-200 mt-5">
            ...
            <div class="mt-5 grid grid-cols-8 gap-4">
                <div class="col-span-2">
                    ...
                    <p class="ml-5 text-base font-bold mostrar_datos mt-2"><?php echo e($service->formatNumber($obra->anticipo_monto)); ?></p>
                </div>
                <div class="col-span-2">
...
<div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal">
    <div class="relative w-auto my-6 mx-auto max-w-3xl">
      ...
      <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
        ...
        <!--body-->
        <form action="<?php echo e(route('update_observacion')); ?>" method="POST" id="formulario_update_obs" name="formulario_update_obs">
          <?php echo csrf_field(); ?>
        ...
        <div class="relative p-6 flex-auto">
            <div class="grid grid-cols-10 gap-4">
                ...
                <div id="div-obs-solv" class="col-span-10">
                    <div class="grid grid-cols-10 gab-4">
                        <div  id="div_observacion" class=" col-span-5">
                            ...
                            <input type="date" name="fecha_observacion" id="fecha_observacion" min="" max="<?php echo e($obra->ejercicio + 1); ?>-03-31" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" >
                        ...
                        <div id="div_solventacion" class="hidden col-span-5">
                            ...
                            <input type="date" name="fecha_solventacion" id="fecha_solventacion" min="" max="<?php echo e($obra->ejercicio + 1); ?>-03-31" class="hidden mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" >
                ...
                <div id="div_validacion" class="hidden col-span-5">
                    ...
                    <input type="date" name="fecha_validacion" id="fecha_validacion" min="" max="<?php echo e($obra->ejercicio + 1); ?>-03-31" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" >
        ...
        <div id="div_acciones" class=" p-4 border-t border-solid border-blueGray-200 rounded-b">
          ...
          <button class="text-red-500 background-transparent font-bold uppercase px-6 py-2 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button" onclick="toggleModal_fechas('modal')">
            Cancelar
          </button>
      ...
      <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
        ...
        <div class="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
            <h4 class="text-lg font-semibold">
                Modificar fechas del proceso de pago <?php echo e($pagos_obra->nombre == 'Anticipo'?'del': 'de la'); ?> <?php echo e($pagos_obra->nombre); ?>

            </h4>
            <button class="p-1 ml-auto bg-transparent border-0 text-black opacity-5 float-right text-3xl leading-none font-semibold outline-none focus:outline-none" onclick="toggleModal_fechas('modal-update-fechas')">
                <span class="bg-transparent text-black opacity-5 h-6 w-6 text-2xl block outline-none focus:outline-none">
        ...
        <!--body-->
        <form action="<?php echo e(route('update_pagos')); ?>" method="POST" id="formulario_upt_pago" name="formulario_upt_pago">
          <?php echo csrf_field(); ?>
          <?php echo method_field('POST'); ?>
        <div class="relative p-6 flex-auto">
            <div class="grid grid-cols-10 gap-4">
                <input type="text" name="id_pago" id="id_pago" maxlength="40" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($pagos_obra->id_desglose_pagos); ?>">
                <input type="text" name="id_obra" id="id_obra" maxlength="40" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obra->id_obra); ?>">
                <?php if($pagos_obra->fecha_validacion == null && $pagos_obra->fecha_pago == null): ?>
                    <div id="validado" class="col-span-10 text-center">
                        <input type="checkbox" id="pagado" name="pagado" >
                        <label for="pagado" class="text-base font-semibold text-red-500"> <?php echo e($pagos_obra->nombre == 'Anticipo'?'El': 'La'); ?> <?php echo e($pagos_obra->nombre); ?> ha sido <?php echo e($pagos_obra->nombre == 'Anticipo'?'pagado': 'pagada'); ?> sin validación de documentos.</label>
                    </div> 
                <?php endif; ?>
                ...
                <?php if($pagos_obra->fecha_recepcion != null): ?>
                    <div class="col-span-5">
                        ...
                        <div id="label_fecha_recepcion" class="mt-1 py-2 px-3">
                            <label class="text-base font-bold text-gay-500" ><?php echo e($service->formatDate($pagos_obra->fecha_recepcion)); ?></label>
                        </div>
                    </div>
                <?php else: ?>
                    <div  id="div_recepcion" class="col-span-5">
                        <label class="block text-sm font-semibold text-gray-700">Fecha de recepción de documentos*</label>
                        <input type="date" name="fecha_recepcion" id="fecha_recepcion" min="<?php echo e($obra->fecha_inicio_programada); ?>" max="<?php echo e($obra->ejercicio + 1); ?>-03-31" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" >
                ...
                <?php if($pagos_obra->fecha_validacion != null): ?>
                    <div class="col-span-5">
                        ...
                        <div id="label_fecha_validacion" class="mt-1 py-2 px-3">
                            <label class="text-base font-bold text-gay-500" ><?php echo e($service->formatDate($pagos_obra->fecha_validacion)); ?></label>
                        </div>
                    </div>
                <?php else: ?>
                    <div  id="div_validacion_edit" class="<?php echo e($pagos_obra->fecha_recepcion == null?'hidden':''); ?> col-span-5">
                        <label for="fecha_pago" class="block text-sm font-semibold text-gray-700">Fecha de pago <?php echo e($pagos_obra->nombre == 'Anticipo'?'del': 'de la'); ?> <?php echo e($pagos_obra->nombre); ?>*</label>
                        <input type="date" name="fecha_validacion_edit" id="fecha_validacion_edit" min="<?php echo e($pagos_obra->fecha_recepcion); ?>" max="<?php echo e($obra->ejercicio + 1); ?>-03-31" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" >
                ...
                <?php if($pagos_obra->fecha_pago != null): ?>
                    <div class="col-span-5">
                        ...
                        <div id="label_fecha_pago" class="mt-1 py-2 px-3">
                            <label class="text-base font-bold text-gay-500" ><?php echo e($service->formatDate($pagos_obra->fecha_pago)); ?></label>
                        </div>
                    </div>
                <?php else: ?>
                    <div  class="<?php echo e($pagos_obra->fecha_validacion == null?'hidden':''); ?> col-span-10 sm:col-span-5 div_pago">
                        <label for="fecha_pago" class="block text-sm font-semibold text-gray-700">Fecha de pago <?php echo e($pagos_obra->nombre == 'Anticipo'?'del': 'de la'); ?> <?php echo e($pagos_obra->nombre); ?>*</label>
                        <input type="date" name="fecha_pago" id="fecha_pago" min="<?php echo e($pagos_obra->fecha_recepcion); ?>" max="<?php echo e($obra->ejercicio + 1); ?>-03-31" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" >
                    ...
                    <?php if($estimacion != null): ?>
                        ...
                        <div class="<?php echo e($pagos_obra->fecha_validacion == null?'hidden':''); ?> col-span-10 div_pago">
                        ...
                        <?php if($obra->anticipo_monto > 0): ?>
                            <div class="<?php echo e($pagos_obra->fecha_validacion == null?'hidden':''); ?> col-span-10 sm:col-span-5 div_pago">  
                                ...
                                <label id="error_amortizacion_anticipo_so" name="error_amortizacion_anticipo_so" class="hidden text-base font-normal text-red-500" >El monto excede el restante por amortizar <?php echo e($service->formatNumber( $obra->anticipo_monto-$total_pagado->total_anticipo)); ?>.</label>
                        ...
                        <?php if($obra->anticipo_monto == 0 && $estimacion->numero_estimacion == 1): ?>
                            <div class="<?php echo e($pagos_obra->fecha_validacion == null?'hidden':''); ?> col-span-10 sm:col-span-5 div_pago">
                                ...
                                <input type="text" name="folio_fianza_cumplimiento" id="folio_fianza_cumplimiento" maxlength="36" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('oficio_notificacion')); ?>">
                    ...
                    <?php endif; ?>
                    <?php if($pagos_obra->nombre == 'Anticipo'): ?>
                        <div class="<?php echo e($pagos_obra->fecha_validacion == null?'hidden':''); ?> col-span-10 sm:col-span-5 div_pago">
                            <label  id="label_folio_factura_anticipo" class="block text-sm font-bold text-gray-700">Folio de factura del anticipo:</label>
                            <input type="text" name="folio_factura_anticipo" id="folio_factura_anticipo" maxlength="36" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('oficio_notificacion')); ?>">
                        ...
                        <div class="<?php echo e($pagos_obra->fecha_validacion == null?'hidden':''); ?> col-span-10 sm:col-span-5 div_pago">
                            ...
                            <input type="text" name="folio_fianza_anticipo" id="folio_fianza_anticipo" maxlength="36" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('oficio_notificacion')); ?>">
        ...
        <div id="div_acciones" class=" p-4 border-t border-solid border-blueGray-200 rounded-b">
          ...
          <span class="block text-xs">Verifique los campos obligatorios marcados con un ( * ) </span>
          <div class="text-right">
          <button class="text-red-500 background-transparent font-bold uppercase px-6 py-2 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button" onclick="toggleModal_fechas('modal-update-fechas')">
            Cancelar
          </button>
          <button type="submit" id="guardar_pago" class="bg-green-500 text-white active:bg-green-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" >
            Guardar
          </button>
          </div>
        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        console.log("<?php echo e(count($observaciones)); ?>");
        ...
        $("#guardar").click(function () {  
            fecha_pago = '<?php echo e($pagos_obra->fecha_recepcion); ?>';
            estado = false;
            ...
            if($("#fecha_validacion_edit").length == 0 || $("#fecha_pago").val() != ''){
                ...
                if($("#amortizacion_anticipo").length > 0 && $("#amortizacion_anticipo").val() == ''){
                    ...
                    if($("#amortizacion_anticipo").length > 0) {
                        ...
                        falta_amortizar = <?php echo e($obra->anticipo_monto - $total_pagado->total_anticipo); ?>;
        ...
        $("#total_estimacion").on({
            ...
            "keyup": function(event) {
                ...
                console.log()
                monto_restante = <?php echo e($obra->monto_modificado?$obra->monto_modificado:$obra->monto_contratado); ?> - <?php echo e($total_pagado->total_estimaciones?$total_pagado->total_estimaciones:0); ?>;
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Documentos\CMR\Creatividad\Sistema\cmr_app\resources\views/obra/show_pagos.blade.php ENDPATH**/ ?>