...
<table id="example" class="table table-striped bg-white" style="width:100%;">
  ...
  <tbody> 
  <?php $__currentLoopData = $municipio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $index): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
          
          <td>
            <div class="text-sm leading-5 font-medium text-gray-900">
              <?php echo e($index->id_municipio); ?>
          ...
          <td>
            <div class="text-sm leading-5 font-medium text-gray-900">
            <?php echo e($index->distrito->nombre); ?>
          ...
          <td>
            ...
            <form action="<?php echo e(route('municipio.destroy', $index->id_municipio)); ?>" method="POST" class="form-eliminar" >
              <div>
              <a type="button"  href="<?php echo e(route('municipio.edit', $index->id_municipio)); ?>" class="bg-white text-sm text-blue-500 font-normal text-ms p-2 rounded rounded-lg">Editar</a>
              <button class="bg-transparent text-blue-500 active:bg-transparent font-normal  text-sm p-2  rounded outline-none focus:outline-none  ease-linear transition-all duration-150" type="button" onclick="toggleModal('modal-id', <?php echo e($index); ?>, <?php echo e($distrito); ?>)">
    Detalles
    </button>
              <!--<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Nueva carpeta (2)\CMR\Sistema\cmr_app\resources\views/municipio/index.blade.php ENDPATH**/ ?>