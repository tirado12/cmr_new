    ...
    <div class="mt-6 p-8 shadow-2xl bg-white rounded-lg">
        ...
        <div class="mt-5 grid grid-cols-10 gap-4">
            ...
            <div class="col-span-10">
                ...
                <p class="text-base font-bold mostrar_datos text-center"><?php echo e($obra->nombre_corto_obra); ?></p>
            </div>
            <div class="col-span-10 sm:col-span-3">
                <p class="text-sm font-semibold text-center sm:text-left">Localidad:</p>
                <p class="text-base font-bold mostrar_datos text-center"><?php echo e($obra->nombre_localidad); ?></p>
            </div>
            <div class="col-span-10 sm:col-span-3">
                <p class="text-sm font-semibold text-center sm:text-left">Municipio:</p>
                <p class="text-base font-bold mostrar_datos text-center"><?php echo e($obra->nombre_municipio); ?></p>
            </div>
            <div class="col-span-5 sm:col-span-2">
                <p class="text-sm font-semibold text-center sm:text-left">Municipio:</p>
                <p class="text-base font-bold mostrar_datos text-center"><?php echo e($obra->nombre_distrito); ?></p>
            </div>
            <div class="col-span-5 sm:col-span-2">
                <p class="text-sm font-semibold text-center sm:text-left">Estado:</p>
                <p class="text-base font-bold mostrar_datos text-center"><?php echo e($obra->nombre_estado); ?></p>
            </div>
        </div>
        ...
        <div class="mt-5 grid grid-cols-8 gap-4">
            <div class="col-span-8 sm:col-span-2">
                ...
                <p class="text-base font-bold mostrar_datos text-center"><?php echo e($contrato->numero_contrato); ?></p>
            </div>
            <div class="col-span-8 sm:col-span-2">
                <p class="text-sm font-semibold text-center sm:text-left">Fecha de contrato:</p>
                <p class="text-base font-bold mostrar_datos text-center"><?php echo e($service->formatDate($contrato->fecha_contrato)); ?></p>
            </div>
            <div class="col-span-8 sm:col-span-2">
                <p class="text-sm font-semibold text-center sm:text-left">Monto contratado:</p>
                <p class="text-base font-bold mostrar_datos text-center"><?php echo e($service->formatNumber($contrato->monto_contratado)); ?></p>
            </div>
            <div class="col-span-8 sm:col-span-2">
                <p class="text-sm font-semibold text-center sm:text-left">Monto contratado:</p>
                <p class="text-base font-bold mostrar_datos text-center"><?php echo e($contrato->rfc); ?> - <?php echo e($contrato->razon_social); ?></p>
            </div>
            <div class="col-span-8 sm:col-span-4 ">
                ...
                <div class="grid grid-cols-4 gap-4">
                    ...
                    <div class="col-span-4 sm:col-span-2">
                        <p class="text-base font-bold mostrar_datos text-center"><?php echo e($service->formatDate($contrato->fecha_inicio)); ?></p>
                        <p class="text-sm font-semibold text-center">Fecha inicial </p>
                    </div>
                    <div class="col-span-4 sm:col-span-2">
                        <p class="text-base font-bold mostrar_datos text-center"><?php echo e($service->formatDate($contrato->fecha_fin)); ?></p>
        ...
        <div class="">
            <?php if($total_admin < $contrato->monto_contratado): ?>
    ...
    <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
        ...
        <div class="relative p-6 flex-auto">
            <div class="grid grid-cols-10 gap-4">
                <input type="text" name="id_obra_admin_factura" id="id_obra_admin_factura" maxlength="40" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($contrato->obra_administracion_id); ?>">
                <input type="text" name="id_obra_factura" id="id_obra_factura" maxlength="40" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obra->id_obra); ?>">
                <input type="text" name="id_contrato_factura" id="id_contrato_factura" maxlength="40" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($contrato->id_contrato_arrendamiento); ?>">
                ...
                <div class="col-span-10 sm:col-span-5">
                    ...
                    <input type="date" name="fecha_factura" id="fecha_factura" min="<?php echo e($contrato->fecha_inicio); ?>" max="<?php echo e($contrato->fecha_fin); ?>" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('fecha_oficio_notificacion')); ?>">
                ...
                <div class="col-span-10 sm:col-span-5">
                    ...
                    <label id="error_monto_admin_mayor_fac" class="hidden text-base font-normal text-red-500" >El monto es mayor que el restante de la obra: <?php echo e($service->formatNumber($contrato->monto_contratado - $total_admin)); ?></label>
                ...
                <div class="col-span-10">
                    ...
                    <select class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" name="proveedor_id" id="proveedor_id" >
                        <option value="<?php echo e($contrato->id_proveedor); ?>"><?php echo e($contrato->rfc); ?> - <?php echo e($contrato->razon_social); ?></option>
                    </select>
    ...
    <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
        ...
        <div class="relative p-6 flex-auto">
            <div class="grid grid-cols-10 gap-4">
                ...
                <input type="text" name="id_obra_factura_edit" id="id_obra_factura_edit" maxlength="40" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($obra->id_obra); ?>">
                <input type="text" name="id_contrato_factura_edit" id="id_contrato_factura_edit" maxlength="40" class="hidden mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($contrato->id_contrato_arrendamiento); ?>">
                <div class="col-span-10 sm:col-span-5">
                ...
                <div class="col-span-5">
                    ...
                    <input type="date" name="fecha_factura_edit" id="fecha_factura_edit" min="<?php echo e($contrato->fecha_inicio); ?>" max="<?php echo e($contrato->fecha_fin); ?>" class="mt-1 focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(old('fecha_oficio_notificacion')); ?>">
                ...
                <div class="col-span-5 sm:col-span-5">
                    ...
                    <label id="error_monto_admin_mayor_fac_edit" class="hidden text-base font-normal text-red-500" >El monto es mayor que el restante de la obra: <?php echo e($service->formatNumber($contrato->monto_contratado - $total_admin)); ?></label>
        ...
        $('.js-example-basic-single').select2();
            $("#total_factura").on({
                "keyup": function(event) {
                    ...
                    total_obra = <?php echo e($contrato->monto_contratado); ?>;
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Nueva carpeta (2)\CMR\Sistema\cmr_app\resources\views/obra/show_contrato.blade.php ENDPATH**/ ?>