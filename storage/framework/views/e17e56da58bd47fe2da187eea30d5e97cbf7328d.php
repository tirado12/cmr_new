...
<?php $__env->startSection('title','Editar gastos indirectos'); ?>
...
<div class="mt-20 sm:mt-0 shadow-2xl bg-white rounded-lg">
    ...
    <div class="mt-5 md:mt-0 md:col-span-2">
      <form action="<?php echo e(route('gastosIndirectos.update', $gastosIndirecto)); ?>" method="POST" id="formulario" name="formulario">
        <?php echo csrf_field(); ?>
        ...
        <div class="shadow overflow-hidden sm:rounded-md">
          <div class="px-4 py-5 bg-white sm:p-6"> 
            <div class="grid grid-cols-6 gap-6">
              <div class="col-span-6 sm:col-span-3">
                ...
                <input type="text" name="clave" id="clave" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($gastosIndirecto->clave); ?>">
              ...
              <div class="col-span-6 sm:col-span-3">
                ...
                <input type="text" name="nombre" id="nombre" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e($gastosIndirecto->nombre); ?>">
          ...
          <div class="px-4 py-3 bg-gray-100 sm:px-6">
            ...
            <div class="text-right">
              <a type="button" href="<?php echo e(route('gastosIndirectos.index')); ?>" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-gray-500 hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Regresar
              </a>
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Nueva carpeta (2)\CMR\Sistema\cmr_app\resources\views/gastos_indirectos/edit.blade.php ENDPATH**/ ?>