      ...
      <tr>
          ...
          <td>
            <div class="flex items-center">
              <div>
                  <div class="text-sm leading-5 font-medium text-gray-900"><?php echo e($proveedor->rfc); ?></div>
          ...
          <td>
            ...
            <form action="<?php echo e(route('proveedor.destroy', $proveedor->id_proveedor)); ?>" method="POST" class="form-eliminar" >
              <div>
              <a type="button"  href="<?php echo e(route('proveedor.edit', $proveedor->id_proveedor)); ?>" class="bg-white text-blue-500 p-2 rounded rounded-lg">Editar</a>
...
<div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-id">
  <div class="relative w-auto my-6 mx-auto max-w-3xl">
    ...
    <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
      ...
      <!--body-->
      <form action="<?php echo e(route('proveedor.store')); ?>" method="POST" id="formulario" name="formulario">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Documentos\CMR\Creatividad\Sistema\cmr_app\resources\views/proveedores/index.blade.php ENDPATH**/ ?>