<nav class="sticky top-0 bg-blue-cmr1 ">
    ...
    <div class="flex-shrink-0 flex items-center justify-center w-full">
        <img class="block lg:hidden h-10 w-auto" src="<?php echo e(asset('image/Icono CMR White.png')); ?>" alt="Workflow">
        <img class="hidden lg:block h-14 w-auto" src="<?php echo e(asset('image/CMR logo blanco.png')); ?>" alt="Workflow">
    </div>
    ...
    <div class="ml-3 relative z-40" x-data="{ open: false }">
        ...
        <button x-on:click="open = true" type="button" class=" flex text-sm rounded-full " id="user-menu" aria-expanded="false" aria-haspopup="true">
            ...
            <h6 class="font-bold ml-2 mr-2 text-white"><?php echo e(Auth::user()->name); ?></h6>
...
</script><?php /**PATH D:\Documentos\CMR\Creatividad\Sistema\cmr_app\resources\views/componentes/navbar.blade.php ENDPATH**/ ?>