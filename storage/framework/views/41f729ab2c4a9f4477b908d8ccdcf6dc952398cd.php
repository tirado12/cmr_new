...
<?php $__env->startSection('title','Gastos indirectos'); ?>
...
<div class="contenedor p-8 shadow-2xl bg-white rounded-lg">
    ...
    <table id="example" class="table table-striped bg-white" style="width:100%;">
      ...
      <tbody> 
        <?php $__currentLoopData = $gastosIndirectos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gasto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
              
              
              <td>
                <div class="text-sm leading-5 font-medium text-gray-900">
                    <?php echo e($gasto->clave); ?>
              ...
              <td>
                ...
                <form action="<?php echo e(route('gastosIndirectos.destroy', $gasto->id_indirectos)); ?>" method="POST" class="form-eliminar" >
                  <div>
                  <a type="button"  href="<?php echo e(route('gastosIndirectos.edit', $gasto->id_indirectos)); ?>" class="bg-blue-200 text-blue-700 border border-blue-700 p-2 focus:outline-none rounded rounded-lg">Editar</a>
                  <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Nueva carpeta (2)\CMR\Sistema\cmr_app\resources\views/gastos_indirectos/index.blade.php ENDPATH**/ ?>