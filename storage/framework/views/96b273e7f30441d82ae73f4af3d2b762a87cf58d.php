...
<div class="flex flex-col mt-6">
    <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
        <a href="<?php echo e(route('sisplade.create')); ?>"><button class="bg-orange-800 mb-4 text-white active:bg-orange-800 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button" >
        Agregar
        </button></a>
    </div>
</div>
...
<div class="mt-6 contenedor p-8 shadow-2xl bg-white rounded-lg">
    ...
    <table id="example" class="table table-striped bg-white" style="width:100%;">
      ...
      <tbody> 
      <?php $__currentLoopData = $sisplade; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          
          <tr>
              <td>
                <div class="text-sm leading-5 font-medium text-gray-900 flex justify-center">
                  <?php echo e($clientes->find($item->fuentesCliente->cliente_id)->nombre); ?>

                </div>
              </td>
             <td>
                <div class="text-sm leading-5 font-medium text-gray-900 myDIV flex justify-center">
                 <?php echo e($fuentes->find($item->fuentesCliente->fuente_financiamiento_id)->nombre_corto); ?>

                </div>
              </td>
              <td>
                <div class="text-sm leading-5 font-medium text-gray-900 flex justify-center" id="capturado">
                    <span id="ver_prodim" class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e(($item->capturado == 1 ? " bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800" )); ?>"><?php echo e(($item->capturado == 1 ? "Capturado" : "Sin Capturar" )); ?></span>
                </div>
              </td>
              <td>
                <div class="text-sm leading-5 font-medium text-gray-900 flex justify-center">
                    <?php echo e($item->fecha_capturado); ?>

                </div>
              </td>
              <td>
                <div class="text-sm leading-5 font-medium text-gray-900 flex justify-center" id="validacion">
                    <span id="ver_prodim" class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e(($item->validado == 1 ? " bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800" )); ?>"><?php echo e(($item->validado == 1 ? "Validado" : "Sin Validar" )); ?></span>
                </div>
              </td>
              <td>
                <div class="text-sm leading-5 font-medium text-gray-900 flex justify-center">
                   <?php echo e($item->fecha_validado); ?>

                </div>
              </td>
              <td>
                <div class="flex justify-center">
                <form action="<?php echo e(route('sisplade.destroy', $item->id_sisplade)); ?>" method="POST" class="form-eliminar" >
                  <div>
                  <a type="button"  href="<?php echo e(route('sisplade.edit', $item->id_sisplade)); ?>" class="bg-white text-sm text-blue-500 font-normal text-ms p-2 rounded rounded-lg">Editar</a> 
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Nueva carpeta (2)\CMR\Sistema\cmr_app\resources\views/sisplade/index.blade.php ENDPATH**/ ?>