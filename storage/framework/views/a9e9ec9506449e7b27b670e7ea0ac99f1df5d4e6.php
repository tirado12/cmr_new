...
<div class="min-h-screen flex items-center justify-center bg-white py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      <div>
        <img class="mx-auto h-28 w-auto rounded-full shadow-2xl" src="<?php echo e(asset('image/logo.png')); ?>" alt="cmr">
...
</html><?php /**PATH D:\Documentos\CMR\Creatividad\Sistema\cmr_app\resources\views/login.blade.php ENDPATH**/ ?>