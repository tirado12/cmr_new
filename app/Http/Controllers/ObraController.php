...
class ObraController extends Controller
{
    ...
    public function getObrasCliente($cliente_id, $anio){
        ...
        $obras = DB::table('fuentes_clientes')
            ...
            ->orderBy('numero_obra')
            ->select('obras.nombre_corto as nombre_obra' ,'obras.monto_contratado','obras.monto_modificado','obras.avance_tecnico', 'acta_integracion_consejo', 'acta_priorizacion', 'adendum_priorizacion', 'obras.modalidad_ejecucion', 'obras.id_obra')
            ->distinct()
            ->get();
        return $obras;
    }
