...
@section('contenido')
    ...
    <div class="flex flex-row items-center ">
        ...
        <div class="ml-4 grid grid-col-1">
            <p class="block font-black text-xl">Listado de constratistas</p>
    ...
    <div class="mt-7">
        <div class="w-full  px-3">
            <p class="text-gray-600">
                ...
                - 
                <i class="fas fa-user" aria-hidden="true"></i> Contratistas
    ...
    <div class="">
        ...
        <div class="text-base mt-6 shadow-xl bg-white rounded-lg">
            <div class="border-b p-4 flex justify-between items-center bg-blue-cmr1 rounded-t-lg">
                <span class="inline-block font-semibold text-lg text-center text-white uppercase">Listado de contratistas</span>
            ...
            <div class="p-4 ">
                <div class="">
                    <table id="example" class="table table-striped bg-white" style="width:100%;">
                        <thead>
                            <tr>
                                <th class="text-sm text-center">Razon social o nombre</th>
                                ...
                                <tr>
                                        ...
                                        <div>
                                            <p class="text-sm leading-5 font-medium">
                                                @if($contratista->razon_social == null)
                                                    {{ $contratista->apellidos }} {{ $contratista->nombre }}    
                                                @else
                                    ...
                                    <td>
                                        ...
                                        <div class="text-center text-base leading-5 font-medium text-gray-900">
                                            <button type="button"  href="#" class="bg-transparent text-sm text-blue-500 font-normal px-3" onclick="toggleModalContratista('modal-id',{{$contratista}})">Detalles</button>
                                            <button type="button"  href="#" class="bg-transparent text-sm text-green-500 font-normal px-3" onclick="toggleModalFisica('modal-edit-fisica', {{$contratista}})">Editar</button>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
                    ...
                    <div class="relative p-6 flex-auto">
                        ...
                        <div class="grid grid-cols-9 gap-2 mb-7">
                            <div class="col-span-9 sm:col-span-3" >
                                <p id="label_pc_c" class="text-sm text-center">Núm. Padrón Contratistas</p>
                                <p id="pc_c" class="text-base font-semibold px-3 py-2 border border-gray-300 text-center rounded-md bg-gray-100">{{$cliente->nombre_municipio}}</p>
                            </div>
    ...
    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-edit-fisica">
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <!--body-->
            <form action="{{ route('contratista_update') }}" method="POST" id="formulario" name="formulario">
                @csrf
                @method('POST')
                <div class="relative p-6 flex-auto">
                    <div class="grid grid-cols-10 gap-4">
                        <div class="col-span-10 hidden">
                            <input type="text" name="id_contratista" id="id_contratista" class="text-sm font-semibold text-center hidden">
                        ...
                        <div class="col-span-10 sm:col-span-3 ">
                            <label id="label_pc" for="first_pc" class="text-sm font-semibold text-center">Núm. Padrón de Contratista *</label>
                            <input type="text" name="pc" id="pc" class="focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required maxlength="200">
                            <label id="error_pc" name="error_pc" class="hidden text-sm font-normal text-red-500" >Ingrese un número adecuado</label>
                        </div>
                        ...
                        <div class="col-span-10" id="div_razon_social_e">
                            ...
                            <input type="text" name="razon_social" id="razon_social" class="focus:ring-blue-800focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-10 sm:col-span-5">
                            ...
                            <input type="text" name="nombre" id="nombre" class="focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                        ...
                        <div class="col-span-5 sm:col-span-5">
                            ...
                            <input type="text" name="apellidos" id="apellidos" class="focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                        ...
                        <div class="col-span-10 sm:col-span-5 ">
                            ...
                            <input type="text" name="telefono" id="telefono" class="focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required maxlength="200">
                        ...
                        <div class="col-span-10 sm:col-span-5 ">
                            ...
                            <input type="email" name="correo" id="correo" class="focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required maxlength="200">
                        ...
                        <div class="col-span-8 sm:col-span-10">
                            ...
                            <input type="text" name="domicilio" id="domicilio" class="focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                ...
                <div class=" p-4 border-t border-solid border-blueGray-200 rounded-b">
                    <div class="text-right">
                        ...
                        <button id="editar_contratista" type="submit" class="text-blue-500 font-bold uppercase text-sm px-6 rounded outline-none focus:outline-none ease-linear transition-all duration-150" >
                            Guardar
                        </button>
                    </div>
                </div>
    ...
    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-add">
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <!--body-->
            <form action="{{ route('contratista_create') }}" method="POST" id="formulario_cont" name="formulario_cont">
                @csrf
                @method('POST')
                <div class="relative p-6 flex-auto">
                    <div class="grid grid-cols-10 gap-4">
                        ...
                        <div class="col-span-10 sm:col-span-5 ">
                            <label id="label_pc_a" for="first_pc_a" class="text-sm font-semibold text-center">Núm. Padrón de Contratista *</label>
                            <input type="text" name="pc" id="pc_a" class="focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required maxlength="200">
                            <label id="error_pc_a" name="error_pc_a" class="hidden text-sm font-normal text-red-500" >Ingrese un número adecuado</label>
                        </div>

                        <div class="col-span-10 sm:col-span-5 ">
                            <p id="label_rfc_a" for="first_rfc_a" class="text-sm font-semibold">RFC *</p>
                            <input type="text" name="rfc" id="rfc_a" class="focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required maxlength="13" minlength="12">
                        ...
                        <div class="col-span-10 hidden" id="div_razon_social">
                            ...
                            <input type="text" name="razon_social" id="razon_social_a" class="focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                        ...
                        <div class="col-span-10 sm:col-span-5">
                            ...
                            <input type="text" name="nombre" id="nombre_a" class="focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                        ...
                        <div class="col-span-5 sm:col-span-5">
                            ...
                            <input type="text" name="apellidos" id="apellidos_a" class="focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                        ...
                        <div class="col-span-10 sm:col-span-5 ">
                            ...
                            <input type="text" name="telefono" id="telefono_a" class="focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required maxlength="10" minlength="10">
                        ...
                        <div class="col-span-10 sm:col-span-5 ">
                            ...
                            <input type="email" name="correo" id="correo_a" class="focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required maxlength="200">
                        ...
                        <div class="col-span-8 sm:col-span-10">
                            ...
                            <input type="text" name="domicilio" id="domicilio_a" class="focus:ring-blue-800 focus:border-blue-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                ...
                <div class=" px-4 py-2 border-t border-solid border-blueGray-200 rounded-b">
                    <div class="text-right">
                        ...
                        <button id="guardar_contratista" type="submit" class="text-blue-500 font-bold uppercase text-sm px-6 rounded outline-none focus:outline-none ease-linear transition-all duration-150" >
                            Guardar
                        </button>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        function toggleModalContratista(modalID, contratista){
            $("#pc_c").html(contratista.numero_padron_contratista);
            $("#rfc_c").html(contratista.rfc);
            $("#nombre_c").html(contratista.apellidos + " " + contratista.nombre);
            $("#telefono_c").html(contratista.telefono);
            $("#correo_c").html(contratista.correo);
            $("#domicilio_c").html(contratista.domicilio);
                        
            if(contratista.rfc.length == 12){
                $("#representante_legal_c").removeClass("hidden");
                $("#rl_c").html(contratista.razon_social);
        ...
        function toggleModalFisica(modalID, contratista){
            $("#pc").val(contratista.numero_padron_contratista);
            $("#nombre").val(contratista.nombre);
            $("#apellidos").val(contratista.apellidos);
            $("#razon_social").val(contratista.razon_social);
            $("#rfc").html(contratista.rfc);
            $("#correo").val(contratista.correo);
            $("#telefono").val(contratista.telefono);
            $("#domicilio").val(contratista.domicilio);
            $("#id_contratista").val(contratista.id_contratista);
            ...
            $('#example').DataTable({
                ...
                $("#rfc_a").on({
                    "change":function(event) {
                        ...
                        var type = "GET";
                        var ajaxurl = '/existe/contratista';
                        $.ajax({
                            type: type,
                            url: ajaxurl,
                            data: formData,
                ...
                $("#guardar_contratista").click(function () {
                    valido = true;
                    rfc = $("#rfc").text();
                    ...
                    if($("#pc_a").val() == ''){
                        valido = false;
                        $('#error_pc_a').removeClass("hidden");
                    }else{
                        $('#error_pc_a').addClass("hidden");
                    }
                ...
                $("#editar_contratista").click(function () {
                    valido = true;
                    rfc = $("#rfc").html();

                    if($("#pc").val() == ''){
                        valido = false;
                        $('#error_pc').removeClass("hidden");
                    }else{
                        $('#error_pc').addClass("hidden");
                    }
