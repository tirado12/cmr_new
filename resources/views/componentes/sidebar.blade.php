                    ...
                    <h6 class="font-bold mb-2 text-white">Acciones Rapidas</h6>
                        <ul>
                           <li><a type="button" class="p-4 text-white rounded-md hover:bg-gray-800 w-full cursor-pointer" href="{{ route('dashboard')}}"><i class="fas fa-home"></i> Inicio</a></li>
                            <li>
                                <a class="p-4 flex flex-row hover:bg-gray-800 rounded-md cursor-pointer text-white" href="{{ route('gastosIndirectos.index') }}">
                            ...
                            @role('Administrador')
                            <li><a type="button" class="p-4 text-white rounded-md hover:bg-gray-800 w-full cursor-pointer" href="{{ route('admin.users.index')}}"><i class="fas fa-users"></i> Usuarios</a>
                            @endrole
                        </ul>
